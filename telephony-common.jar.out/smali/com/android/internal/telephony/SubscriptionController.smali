...
.field private static final EVENT_WRITE_MSISDN_DONE:I = 0x3
...
.method public setDefaultDataSubId(I)V
    ...
    .prologue
    .line 1479
    const-string v20, "setDefaultDataSubId"
    ...
    .line 1480
    const-string v20, "persist.radio.flexmap_type"

    const-string v21, "nw_mode"
    ...
    .line 1483
    .local v6, "flexMapSupportType":Ljava/lang/String;
    ...
    const-string v21, "setDefaultDataSubId called with DEFAULT_SUB_ID"
    ...
    const-string v21, "[setDefaultDataSubId] subId="
    ...
    .line 1489
    .local v16, "proxyController":Lcom/android/internal/telephony/ProxyController;
    sget-object v20, Lcom/android/internal/telephony/SubscriptionController;->sProxyPhones:[Lcom/android/internal/telephony/PhoneProxy;
    ...
    const-string v21, "[setDefaultDataSubId] num phones="
    ...
    .line 1498
    .local v10, "mCurrentSlot":I
    const/4 v11, -0x1

    .line 1499
    .local v11, "mMainStackSubid":I
    ...
    invoke-virtual {v0, v10}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCard(I)Lcom/android/internal/telephony/uicc/UiccCard;

    move-result-object v19

    .line 1500
    .local v19, "uiccCard":Lcom/android/internal/telephony/uicc/UiccCard;
    const/4 v5, 0x0
    ...
    .line 1502
    invoke-virtual/range {v19 .. v19}, Lcom/android/internal/telephony/uicc/UiccCard;->getNumApplications()I
    ...
    invoke-virtual {v0, v7}, Lcom/android/internal/telephony/uicc/UiccCard;->getApplicationIndex(I)Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    sget-object v21, Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;->APPTYPE_CSIM:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    ...
    sget-object v21, Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;->APPTYPE_RUIM:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCard(I)Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/SubscriptionController;->getSubId(I)[I
    ...
    .line 1531
    .local v18, "rafs":[Landroid/telephony/RadioAccessFamily;
    const/4 v4, 0x0
    ...
    .line 1535
    .local v14, "phone":Lcom/android/internal/telephony/PhoneProxy;
    invoke-virtual {v14}, Lcom/android/internal/telephony/PhoneProxy;->getSubId()I
    ...
    .line 1543
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/telephony/ProxyController;->getMaxRafSupported()I
    ...
    const-string v21, "[setDefaultDataSubId] phoneId="
    ...
    .line 1550
    new-instance v20, Landroid/telephony/RadioAccessFamily;

    move-object/from16 v0, v20

    move/from16 v1, v17

    invoke-direct {v0, v15, v1}, Landroid/telephony/RadioAccessFamily;-><init>(II)V

    aput-object v20, v18, v15
    ...
    .end local v17    # "raf":I
    :cond_8
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/telephony/ProxyController;->getMinRafSupported()I

    move-result v17

    .restart local v17    # "raf":I
    goto :goto_4

    .line 1552
    .end local v8    # "id":I
    .end local v14    # "phone":Lcom/android/internal/telephony/PhoneProxy;
    .end local v17    # "raf":I
    :cond_9
    if-eqz v4, :cond_b
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/ProxyController;->setRadioCapability([Landroid/telephony/RadioAccessFamily;)Z

    .line 1560
    .end local v4    # "atLeastOneMatch":Z
    .end local v15    # "phoneId":I
    .end local v18    # "rafs":[Landroid/telephony/RadioAccessFamily;
    :cond_a
    :goto_5
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/SubscriptionController;->updateAllDataConnectionTrackers()V
    ...
    const-string v21, "multi_sim_data_call"
    ...
    .restart local v18    # "rafs":[Landroid/telephony/RadioAccessFamily;
    :cond_b
    const-string v20, "[setDefaultDataSubId] no valid subId\'s found - not updating."
...
.method public setDisplayNumber(Ljava/lang/String;I)I
    ...
    const-string v12, "[setDisplayNumber]+ subId:"
    ...
    .line 1047
    const-string v11, "setDisplayNumber"

    move-object/from16 v0, p0

    invoke-virtual {v0, v11}, Lcom/android/internal/telephony/SubscriptionController;->enforceModifyPhoneState(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Lcom/android/internal/telephony/SubscriptionController;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    invoke-interface {v6, v2, v0, v8}, Lcom/android/internal/telephony/Phone;->setLine1Number(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
