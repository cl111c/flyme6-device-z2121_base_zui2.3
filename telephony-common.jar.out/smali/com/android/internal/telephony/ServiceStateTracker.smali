...
.field private mNotificationIdCount:I
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/CommandsInterface;Landroid/telephony/CellInfo;)V
    ...
    iput v1, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mNotificationIdCount:I
...
.method private createNotification(Landroid/content/Context;)Landroid/app/Notification;
    ...
    .line 1277
    .local v0, "callIt":Landroid/content/Intent;
    const-string v4, "com.lenovo.leos.simsettings"

    const-string v5, "com.lenovo.leos.simsettings.SimSettingsActivity"

    invoke-virtual {v0, v4, v5}, Landroid/content/Intent;->setClassName(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 1278
    const-string v4, "internation_roaming"
    ...
    .line 1290
    .local v2, "notifycation":Landroid/app/Notification;
    return-object v2
.end method
...
.method private isNeedNotifyInternational(Ljava/lang/String;)Z
    .locals 4
    ...
    const-string v3, "data_roaming_international_notify_"
...
.method protected cacelNotifyInternationalRoaming(Ljava/lang/String;)V
    .locals 4
    .param p1, "imsi"    # Ljava/lang/String;
    ...
    const-string v3, "cancel for imsi"
    ...
    .line 1263
    :cond_1
    iget v2, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mNotificationIdCount:I
    ...
    .line 1266
    .local v0, "notifyManger":Landroid/app/NotificationManager;
...
.method protected doNotifyInternationalRoaming(Ljava/lang/String;)V
    .locals 8
    .param p1, "imsi"    # Ljava/lang/String;
    ...
    .line 1248
    invoke-direct {p0}, Lcom/android/internal/telephony/ServiceStateTracker;->isInternationalRoaming()Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-direct {p0, p1}, Lcom/android/internal/telephony/ServiceStateTracker;->isNeedNotifyInternational(Ljava/lang/String;)Z
    ...
    .line 1249
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/ServiceStateTracker;->createNotification(Landroid/content/Context;)Landroid/app/Notification;

    move-result-object v1

    .line 1250
    .local v1, "notificaton":Landroid/app/Notification;
    iget-object v4, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mPhoneBase:Lcom/android/internal/telephony/PhoneBase;
    ...
    .line 1253
    .local v2, "notifyManger":Landroid/app/NotificationManager;
    iget v4, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mNotificationIdCount:I
    ...
    iget v5, v5, Lcom/android/internal/telephony/PhoneBase;->mPhoneId:I
    ...
    const-string v6, "data_roaming_international_notify_"
