...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/connectivity/Tethering$Listen;,
...
.field private static final TETHERING_LISTEN_INTERVAL_MS:I = 0x927c0
...
.field private final mListen:Lcom/android/server/connectivity/Tethering$Listen;
...
.field private mUsbConnectedCauseByOpenUsbApShare:Z

.field private mUsbTetherDisableRequested:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/os/Looper;)V
    ...
    .line 188
    iput-boolean v5, p0, Lcom/android/server/connectivity/Tethering;->mUsbConnectedCauseByOpenUsbApShare:Z

    .line 191
    iput v5, p0, Lcom/android/server/connectivity/Tethering;->mTetherNum:I

    .line 2147
    new-instance v2, Lcom/android/server/connectivity/Tethering$3;

    invoke-direct {v2, p0}, Lcom/android/server/connectivity/Tethering$3;-><init>(Lcom/android/server/connectivity/Tethering;)V

    iput-object v2, p0, Lcom/android/server/connectivity/Tethering;->mLocaleChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 245
    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering;->showUsbChooseDialog()Landroid/app/AlertDialog;

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/connectivity/Tethering;->mAlertDialog:Landroid/app/AlertDialog;

    .line 247
    iget-object v2, p0, Lcom/android/server/connectivity/Tethering;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v2, p0, Lcom/android/server/connectivity/Tethering;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    :cond_2
    new-instance v2, Lcom/android/server/connectivity/Tethering$Listen;

    iget-object v3, p0, Lcom/android/server/connectivity/Tethering;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    invoke-direct {v2, p1, v3}, Lcom/android/server/connectivity/Tethering$Listen;-><init>(Landroid/content/Context;Landroid/os/PowerManager$WakeLock;)V

    iput-object v2, p0, Lcom/android/server/connectivity/Tethering;->mListen:Lcom/android/server/connectivity/Tethering$Listen;

    .line 255
    iget-object v2, p0, Lcom/android/server/connectivity/Tethering;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lcom/android/server/connectivity/Tethering;->mLocaleChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$1100(Lcom/android/server/connectivity/Tethering;)I
    ...
    .prologue
    .line 106
    iget v0, p0, Lcom/android/server/connectivity/Tethering;->mApState:I
...
.method static synthetic access$1102(Lcom/android/server/connectivity/Tethering;I)I
    ...
    .prologue
    .line 106
    iput p1, p0, Lcom/android/server/connectivity/Tethering;->mApState:I
...
.method static synthetic access$1200(Lcom/android/server/connectivity/Tethering;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/connectivity/Tethering;->mUsbConnectedCauseByOpenUsbApShare:Z
...
.method static synthetic access$1202(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/connectivity/Tethering;->mUsbConnectedCauseByOpenUsbApShare:Z
...
.method static synthetic access$1300(Lcom/android/server/connectivity/Tethering;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/connectivity/Tethering;->mUsbTetherDisableRequested:Z
...
.method static synthetic access$1302(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/connectivity/Tethering;->mUsbTetherDisableRequested:Z

    return p1
.end method

.method static synthetic access$1400(Lcom/android/server/connectivity/Tethering;)Landroid/app/AlertDialog;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;

    .prologue
    .line 106
    iget-object v0, p0, Lcom/android/server/connectivity/Tethering;->mAlertDialog:Landroid/app/AlertDialog;

    return-object v0
.end method

.method static synthetic access$1402(Lcom/android/server/connectivity/Tethering;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
    ...
    .prologue
    .line 106
    iput-object p1, p0, Lcom/android/server/connectivity/Tethering;->mAlertDialog:Landroid/app/AlertDialog;

    return-object p1
.end method

.method static synthetic access$1500(Lcom/android/server/connectivity/Tethering;)Landroid/app/AlertDialog;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$1600(Lcom/android/server/connectivity/Tethering;)Lcom/android/internal/util/StateMachine;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$1700(Lcom/android/server/connectivity/Tethering;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;

    .prologue
    .line 106
    iget-object v0, p0, Lcom/android/server/connectivity/Tethering;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    return-object v0
.end method

.method static synthetic access$1800(Lcom/android/server/connectivity/Tethering;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;

    .prologue
    .line 106
    iget v0, p0, Lcom/android/server/connectivity/Tethering;->mTetherNum:I

    return v0
.end method

.method static synthetic access$1802(Lcom/android/server/connectivity/Tethering;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 106
    iput p1, p0, Lcom/android/server/connectivity/Tethering;->mTetherNum:I
...
.method static synthetic access$3700(Lcom/android/server/connectivity/Tethering;)Landroid/net/INetworkStatsService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$6400(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$6600(Lcom/android/server/connectivity/Tethering;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$7200(Lcom/android/server/connectivity/Tethering;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1}, Lcom/android/server/connectivity/Tethering;->setUsbTethering2(Z)V
...
.method static synthetic access$900(Lcom/android/server/connectivity/Tethering;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/connectivity/Tethering;->mUsbConfigured:Z
...
.method static synthetic access$902(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/connectivity/Tethering;->mUsbConfigured:Z
...
.method private sendTetherStateChangedBroadcast()V
    ...
    const-string v14, "sendTetherStateChangedBroadcast, usbTethered = "
    ...
    const-string v14, ", bluetoothTethered = "
    ...
    const-string v13, "Show showTetheredNotification wifi tethering"
...
.method private setUsbTethering2(Z)V
    .locals 3
    .param p1, "enabled"    # Z
...
.method private showTetheredNotification(I)V
    ...
    .line 734
    iget v10, p0, Lcom/android/server/connectivity/Tethering;->mTetherNum:I
    ...
    .line 736
    iget-object v0, p0, Lcom/android/server/connectivity/Tethering;->mListen:Lcom/android/server/connectivity/Tethering$Listen;

    invoke-virtual {v0}, Lcom/android/server/connectivity/Tethering$Listen;->pause()V
    ...
    invoke-virtual {v0}, Lcom/android/server/connectivity/Tethering$Listen;->resume()V
...
.method private showUsbChooseDialog()Landroid/app/AlertDialog;
    .locals 3
...
.method public setUsbTethering(Z)I
    ...
    iput-boolean v1, p0, Lcom/android/server/connectivity/Tethering;->mUsbTetherDisableRequested:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
