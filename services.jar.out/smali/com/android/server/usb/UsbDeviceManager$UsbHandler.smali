...
.field private final mUsbModeSwitchedReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    iput-object v3, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbModeSwitchedReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {p1, v3}, Lcom/android/server/usb/UsbDeviceManager;->access$502(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    const-string v4, "only_support_usb_2_0"
    ...
    new-instance v6, Lcom/android/server/usb/UsbDeviceManager$UsbSettingsObserver;

    invoke-direct {v6, p1}, Lcom/android/server/usb/UsbDeviceManager$UsbSettingsObserver;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V
    ...
    .line 429
    .local v2, "usbFilter":Landroid/content/IntentFilter;
    const-string v3, "usb.send.type.photo"

    invoke-virtual {v2, v3}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 430
    const-string v3, "usb.send.type.file"
    ...
    iget-object v4, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbModeSwitchedReceiver:Landroid/content/BroadcastReceiver;
    ...
    .end local v2    # "usbFilter":Landroid/content/IntentFilter;
    :goto_0
    return-void
...
.method static synthetic access$300(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Ljava/lang/String;
    .locals 1
...
.method private setAdbEnabled(Z)V
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mAdbEnabled:Z
    invoke-static {v2, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$502(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$700(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
...
.method private setUsb30Disabled(Z)V
    .locals 4
    .param p1, "disable"    # Z
    ...
    const-string v3, "setUsb30Disabled: "
    ...
    .line 540
    :try_start_0
    const-string v1, "/sys/module/dwc3/parameters/usb30_disabled"
    ...
    const-string v2, "failed to write 1 to /sys/module/dwc3/parameters/usb30_disabled"
    ...
    const-string v2, "failed to write 0 to /sys/module/dwc3/parameters/usb30_disabled"
...
.method private trySetEnabledFunctions(Ljava/lang/String;Z)Z
    ...
    invoke-static {v2, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$800(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 618
    :cond_2
    const-string v2, "persist.sys.usb.tether"
    ...
    const-string v4, "For reboot, usb tether config: "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, "persist.sys.usb.tether"
...
.method private updateUsbNotification(Z)V
    ...
    .line 890
    .local v18, "summary_id":I
    const/4 v12, 0x0

    .line 892
    .local v12, "newStyle":Z
    move-object/from16 v0, p0
    ...
    const-string v3, "updateUsbNotification(): mUsbDataUnlocked"
    ...
    .line 990
    .local v9, "intentFile":Landroid/content/Intent;
    const-string v2, "usb.send.type.file"
    ...
    .line 993
    .local v14, "pendingFile":Landroid/app/PendingIntent;
    new-instance v10, Landroid/content/Intent;

    invoke-direct {v10}, Landroid/content/Intent;-><init>()V

    .line 994
    .local v10, "intentPhoto":Landroid/content/Intent;
    const-string v2, "usb.send.type.photo"
    ...
    .line 997
    .local v15, "pendingPhoto":Landroid/app/PendingIntent;
    const v2, 0x1020451
    ...
    iput-object v0, v13, Landroid/app/Notification;->contentView:Landroid/widget/RemoteViews;

    .line 1002
    .end local v9    # "intentFile":Landroid/content/Intent;
    .end local v10    # "intentPhoto":Landroid/content/Intent;
    .end local v14    # "pendingFile":Landroid/app/PendingIntent;
    .end local v15    # "pendingPhoto":Landroid/app/PendingIntent;
    ...
    invoke-virtual {v2, v3, v8, v13, v5}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    const-string v3, "updateUsbNotification(): mtp"
    ...
    const-string v3, "updateUsbNotification(): ptp"
    ...
    const-string v3, "updateUsbNotification(): midi"
    ...
    const-string v3, "updateUsbNotification(): accessory"
    ...
    const-string v3, "updateUsbNotification(): diag"
    ...
    const-string v3, "updateUsbNotification(): none"
    ...
    .restart local v16    # "pi":Landroid/app/PendingIntent;
    goto/16 :goto_3
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v4, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$1102(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->getCurrentSettings()Lcom/android/server/usb/UsbSettingsManager;
    invoke-static {v4}, Lcom/android/server/usb/UsbDeviceManager;->access$1200(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mDebuggingManager:Lcom/android/server/usb/UsbDebuggingManager;
    invoke-static {v4}, Lcom/android/server/usb/UsbDeviceManager;->access$700(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
    ...
    .line 832
    .local v3, "mUsbTetherRebootConfig":Ljava/lang/String;
    const-string v4, "UsbDeviceManager"
    ...
    const-string v6, "MSG_BOOT_COMPLETED  mUsbTetherRebootConfig: "
    ...
    .line 834
    const-string v4, "sys.usb.qxdm_on"
    ...
    invoke-virtual {v4, v5, v6, v7}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->sendEmptyMessageDelayed(IJ)Z

    goto/16 :goto_0

    .line 841
    .end local v3    # "mUsbTetherRebootConfig":Ljava/lang/String;
    :pswitch_8
    ...
    :goto_7
    invoke-direct {p0, v5}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->setUsb30Disabled(Z)V
    ...
    .line 863
    invoke-direct {p0, v5}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->updateAdbNotification(Z)V
    ...
    invoke-virtual {v1, v5}, Landroid/net/ConnectivityManager;->setUsbTethering(Z)I
    ...
    const-string v5, "MSG_USB_TETHER_REBOOT_STATE: setUsbTethering is failed."
    ...
    const-string v5, "MSG_USB_TETHER_REBOOT_STATE: setUsbTethering is success."
