...
.field private static final RTC_ALARM_TIME_PROPERTY:Ljava/lang/String; = "persist.sys.rtc_alarm_time"

.field private static final RTC_MASK:I = 0x2

.field private static final RTC_POWEROFF_WAKEUP_MASK:I = 0x20

.field private static final RTC_START_TIME_PROPERTY:Ljava/lang/String; = "persist.sys.rtc_start_time"
...
.method private setLocked(IJ)V
    ...
    .line 1908
    :cond_2
    const-string v0, "persist.sys.rtc_start_time"
...
.method clearRtcAlarmProperty()V
    .locals 4
    ...
    .line 718
    const-string v1, "persist.sys.rtc_alarm_time"
    ...
    const-string v2, "reset RTC_ALARM_TIME_PROPERTY to 0!"
...
.method deliverAlarmsLocked(Ljava/util/ArrayList;J)V
    ...
    :goto_1
    :try_start_0
    iget-object v5, v13, Lcom/android/server/AlarmManagerService$Alarm;->tag:Ljava/lang/String;

    if-eqz v5, :cond_0

    iget-object v5, v13, Lcom/android/server/AlarmManagerService$Alarm;->tag:Ljava/lang/String;

    const-string v6, "SportsServiceReceiver"
    ...
    const-string v7, "sending sport alarm "
    ...
    const-string v7, "sending WAKEUP alarm: "
...
.method rebatchAllAlarmsLocked(Z)V
    ...
    .line 710
    invoke-virtual {p0}, Lcom/android/server/AlarmManagerService;->clearRtcAlarmProperty()V
...
.method setImpl(IJJJLandroid/app/PendingIntent;ILandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
    ...
    const-string v8, "com.zui.net.data.monitor"
    ...
    const-string v10, "Don\'t force to set interval time for the get creator package name:"
...
.method triggerAlarmsLocked(Ljava/util/ArrayList;JJ)Z
    ...
    iget-object v4, v0, Lcom/android/server/AlarmManagerService$Alarm;->tag:Ljava/lang/String;
    ...
    const-string v5, "SportsServiceReceiver"
    ...
    const-string v8, "trigger sport alarm: "
    ...
    const-string v8, "trigger sport alarm, lastTime: "
    ...
    const-string v8, "trigger sport alarm, wakeup: "
    ...
    iget-boolean v8, v0, Lcom/android/server/AlarmManagerService$Alarm;->wakeup:Z
