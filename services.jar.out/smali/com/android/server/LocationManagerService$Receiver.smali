...
.method public callLocationChangedLocked(Landroid/location/Location;)Z
    ...
    const-string v2, "location changed pkg:"
    ...
    .line 838
    .local v7, "changeLocation":Landroid/location/Location;
    ...
    const-string v0, "com.zui.position.travel"

    const-string v1, "key_location_from"
    ...
    .line 840
    .local v10, "isTravel":Z
    :goto_0
    iget-object v0, p0, Lcom/android/server/LocationManagerService$Receiver;->this$0:Lcom/android/server/LocationManagerService;

    iget v1, p0, Lcom/android/server/LocationManagerService$Receiver;->mUid:I

    # invokes: Lcom/android/server/LocationManagerService;->isPositionTravel(I)Z
    invoke-static {v0, v1}, Lcom/android/server/LocationManagerService;->access$1400(Lcom/android/server/LocationManagerService;I)Z

    move-result v11

    .line 841
    .local v11, "isTravelUid":Z
    if-eqz v10, :cond_1

    const-string v0, "key_location_from"
    ...
    const-string v2, "ignore this location change for uid="
    ...
    .line 871
    .end local v7    # "changeLocation":Landroid/location/Location;
    .end local v9    # "extras":Landroid/os/Bundle;
    .end local v10    # "isTravel":Z
    .end local v11    # "isTravelUid":Z
    :goto_1
    return v0

    .restart local v7    # "changeLocation":Landroid/location/Location;
    ...
    .line 846
    .restart local v10    # "isTravel":Z
    .restart local v11    # "isTravelUid":Z
    :cond_6
    iget-object v0, p0, Lcom/android/server/LocationManagerService$Receiver;->mListener:Landroid/location/ILocationListener;

    invoke-interface {v0, v7}, Landroid/location/ILocationListener;->onLocationChanged(Landroid/location/Location;)V
