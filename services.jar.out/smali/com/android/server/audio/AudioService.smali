...
.field private static final MSG_KILL_PLAY_SERVICE_PROCESS:I = 0x12c
...
.field private static final STATE_4PINS_HEADPHONE_CONNECTED:I = 0x1

.field private static final STATE_4PINS_HEADPHONE_DISCONNECTED:I = 0x2

.field private static final STATE_4PINS_HEADSET_CONNECTED:I = 0x3

.field private static final STATE_4PINS_UNKNOWN:I = 0x0
...
.field private static final VIBRATE_WHEN_SILENCE:Ljava/lang/String; = "vibrate_when_ringing"
...
.field private mHeadset4PinsDetected:Z

.field private mHeadset4PinsState:I
...
.field private mMusicSteamFromMuteToUnmute:Z
...
.field private mPlayState:Ljava/util/HashMap;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 265
    iput-boolean v6, p0, Lcom/android/server/audio/AudioService;->mMusicSteamFromMuteToUnmute:Z
    ...
    iput-object v0, p0, Lcom/android/server/audio/AudioService;->mPlayState:Ljava/util/HashMap;
    ...
    .line 3910
    iput v6, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsState:I

    .line 3911
    iput-boolean v6, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsDetected:Z
...
.method static synthetic access$4600(Lcom/android/server/audio/AudioService;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/audio/AudioService;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 141
    invoke-direct {p0, p1}, Lcom/android/server/audio/AudioService;->isStreamMusicNotMuteDevice(I)Z
...
.method static synthetic access$4800(Lcom/android/server/audio/AudioService;)Z
    ...
    .prologue
    .line 141
    iget-boolean v0, p0, Lcom/android/server/audio/AudioService;->mMusicSteamFromMuteToUnmute:Z

    return v0
.end method

.method static synthetic access$4802(Lcom/android/server/audio/AudioService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/audio/AudioService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 141
    iput-boolean p1, p0, Lcom/android/server/audio/AudioService;->mMusicSteamFromMuteToUnmute:Z
...
.method private adjustStreamVolume(IIILjava/lang/String;Ljava/lang/String;I)V
    ...
    iput-boolean v5, v0, Lcom/android/server/audio/AudioService;->mMusicSteamFromMuteToUnmute:Z
    ...
    invoke-virtual {v14, v5, v12, v0}, Lcom/android/server/audio/AudioService$VolumeStreamState;->setIndex(IILjava/lang/String;)Z
...
.method private checkAllAliasStreamVolumes()V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/audio/AudioService;->isStreamMusicNotMuteDevice(I)Z
...
.method private checkForRingerModeChange(IIIZ)I
    ...
    const-string v7, "checkForRingerModeChange  oldIndex:"
...
.method private checkSendBecomingNoisyIntent(II)I
    ...
    iget-boolean v2, v0, Lcom/android/server/audio/AudioService;->mHeadset4PinsDetected:Z
    ...
    iget v3, v0, Lcom/android/server/audio/AudioService;->mHeadset4PinsState:I
...
.method private getConnetedDevices()I
    .locals 5
    ...
    .line 1547
    .local v2, "spec":Lcom/android/server/audio/AudioService$DeviceListSpec;
    iget v3, v2, Lcom/android/server/audio/AudioService$DeviceListSpec;->mDeviceType:I
    ...
    .line 1549
    .end local v2    # "spec":Lcom/android/server/audio/AudioService$DeviceListSpec;
    :cond_0
    monitor-exit v4
...
.method private isPluginForMusic(I)Z
    .locals 3
    .param p1, "stramType"    # I
    ...
    .line 1531
    .local v1, "device":I
    invoke-direct {p0}, Lcom/android/server/audio/AudioService;->getConnetedDevices()I
...
.method private isStreamMusicNotMuteDevice(I)Z
    .locals 2
    .param p1, "streamType"    # I
...
.method private killPlayServiceProcess(I)V
    .locals 12
    .param p1, "uid"    # I
    ...
    const-string v10, "killPlayServiceProcess---uid:"
    ...
    .line 1025
    iget-object v8, p0, Lcom/android/server/audio/AudioService;->mPlayState:Ljava/util/HashMap;
    ...
    .line 1039
    .local v5, "r":Landroid/app/ActivityManager$RecentTaskInfo;
    iget-object v8, v5, Landroid/app/ActivityManager$RecentTaskInfo;->baseActivity:Landroid/content/ComponentName;
    ...
    iget v9, v5, Landroid/app/ActivityManager$RecentTaskInfo;->id:I
    ...
    invoke-interface {v8, v9, v10}, Landroid/app/IActivityManager;->forceStopPackage(Ljava/lang/String;I)V
    ...
    const-string v10, "forceStopPackage for pausing play state in the long time,pkg name:"
    ...
    iget-object v10, v5, Landroid/app/ActivityManager$RecentTaskInfo;->baseActivity:Landroid/content/ComponentName;
    ...
    .end local v5    # "r":Landroid/app/ActivityManager$RecentTaskInfo;
    .end local v6    # "recents":Ljava/util/List;, "Ljava/util/List<Landroid/app/ActivityManager$RecentTaskInfo;>;"
    :cond_2
    :goto_1
    return-void
    ...
    .restart local v5    # "r":Landroid/app/ActivityManager$RecentTaskInfo;
    .restart local v6    # "recents":Ljava/util/List;, "Ljava/util/List<Landroid/app/ActivityManager$RecentTaskInfo;>;"
    :cond_3
    add-int/lit8 v1, v1, 0x1
    ...
    const-string v11, "PlayStateInPauseForLongTime"
...
.method private muteRingerModeStreams()V
    ...
    const-string v3, "add mute flag for stream type:"
    ...
    invoke-direct {v0, v13}, Lcom/android/server/audio/AudioService;->isPluginForMusic(I)Z
    ...
    const-string v3, "igore mute this stream type:"
...
.method private onSetStreamVolume(IIIILjava/lang/String;)V
    ...
    const-string v3, "onSetStreamVolume  set RingerMode from Silent mode(volume index 0) to :"
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "before handle device connection state device:"
...
.method private sendDeviceConnectionIntent(IILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 5292
    iget-boolean v2, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsDetected:Z
...
.method public checkPlayState(I)I
    .locals 5
    .param p1, "uid"    # I
    ...
    .line 1012
    iget-object v3, p0, Lcom/android/server/audio/AudioService;->mPlayState:Ljava/util/HashMap;
    ...
    .line 1013
    .local v1, "tempState":Ljava/lang/Object;
    if-nez v1, :cond_0

    .line 1018
    .end local v1    # "tempState":Ljava/lang/Object;
    :goto_0
    return v2

    .line 1016
    .restart local v1    # "tempState":Ljava/lang/Object;
    :cond_0
    :try_start_0
...
.method public notifyFourPinsHeadset()V
    .locals 4
    ...
    .line 3915
    :try_start_0
    iget v0, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsState:I
    ...
    iput-boolean v0, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsDetected:Z
    ...
    const-string v3, "notifyFourPinsHeadset(), mHeadset4PinsState = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsState:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ", mHeadset4PinsDetected = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsDetected:Z
...
.method public notifyPlayState(II)V
    .locals 6
    .param p1, "uid"    # I
    .param p2, "state"    # I
    ...
    const-string v3, "notifyPlayState---uid:"
    ...
    .line 999
    :cond_1
    iget-object v1, p0, Lcom/android/server/audio/AudioService;->mPlayState:Ljava/util/HashMap;
    ...
    .line 1000
    .local v0, "tempState":Ljava/lang/Object;
    if-eqz v0, :cond_2
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/audio/AudioService$AudioHandler;->removeMessages(I)V
    ...
    invoke-virtual {v2, v4, p1, v3}, Lcom/android/server/audio/AudioService$AudioHandler;->obtainMessage(III)Landroid/os/Message;

    move-result-object v2

    const-wide/32 v4, 0x493e0

    invoke-virtual {v1, v2, v4, v5}, Lcom/android/server/audio/AudioService$AudioHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public setBluetoothScoOn(Z)V
    ...
    const-string v2, "Delaying BTSco disconnection for non voice usecase"
    ...
    const-string v2, "Proceed for BTSco disconnection"
...
.method public setStreamVolume(IIILjava/lang/String;)V
    ...
    const-string v2, "onSetStreamVolume  streamType="
...
.method public setWiredDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput v1, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsState:I

    .line 3939
    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/android/server/audio/AudioService;->mHeadset4PinsDetected:Z
