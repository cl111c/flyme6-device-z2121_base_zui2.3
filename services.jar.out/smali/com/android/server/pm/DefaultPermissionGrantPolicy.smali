...
.method private grantRuntimePermissionsLPw(Landroid/content/pm/PackageParser$Package;Ljava/util/Set;ZZI)V
    ...
    .line 782
    .local p2, "permissions":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    const-string v1, "TianynDebugDefault : "

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "grantRuntimePermissionsLPw "
    ...
    const-string v3, "grantRuntimePermissionsLPw                   Grant Done"
...
.method private isSysComponentOrPersistentPlatformSignedPrivAppLPr(Landroid/content/pm/PackageParser$Package;)Z
    ...
    .line 850
    const-string v2, "TianynDebugDefault : "

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "isSysComponentOrPersistentPlatformSignedPrivAppLPr is 1 systemComponent "
    ...
    .line 857
    .local v1, "sysPkg":Lcom/android/server/pm/PackageSetting;
    if-eqz v1, :cond_3
    ...
    const-string v4, "isSysComponentOrPersistentPlatformSignedPrivAppLPr is 2 PersistentPlatformSignedPrivApp "
...
.method public grantDefaultPermissions(I)V
    ...
    const-string v2, "grantPermissionsToSysComponentsAndPrivApps begin ......"
    ...
    const-string v2, "grantPermissionsToSysComponentsAndPrivApps end   ......"
    ...
    const-string v2, "grantDefaultSystemHandlerPermissions       begin ......"
    ...
    const-string v2, "grantDefaultSystemHandlerPermissions       end ......"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 172
    new-instance v0, Lcom/android/server/pm/XuiDefaultPermissionGrantPolicy;

    iget-object v1, p0, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->mService:Lcom/android/server/pm/PackageManagerService;

    invoke-direct {v0, v1}, Lcom/android/server/pm/XuiDefaultPermissionGrantPolicy;-><init>(Lcom/android/server/pm/PackageManagerService;)V

    .line 173
    .local v0, "mXuiDefaultPermissionGrantPolicy":Lcom/android/server/pm/XuiDefaultPermissionGrantPolicy;
    invoke-virtual {v0, p1}, Lcom/android/server/pm/XuiDefaultPermissionGrantPolicy;->grantPermissionsToXuiDefaultSystemApps(I)V

    .line 174
    invoke-virtual {v0, p1}, Lcom/android/server/pm/XuiDefaultPermissionGrantPolicy;->grantPermissionToUserApps(I)V
