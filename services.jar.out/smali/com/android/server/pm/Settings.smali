...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/pm/Settings$PackageState;,
...
.field final mStates:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap",
            "<",
...
.method constructor <init>(Ljava/io/File;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, Lcom/android/server/pm/Settings;->mStates:Landroid/util/ArrayMap;

    .line 231
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/pm/Settings;->mShutDown:Z
...
.method getPackageStopSate(Ljava/lang/String;I)Z
    .locals 5
    ...
    .line 409
    .local v1, "stopped":Z
    iget-object v2, p0, Lcom/android/server/pm/Settings;->mStates:Landroid/util/ArrayMap;

    invoke-virtual {v2, p1}, Landroid/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/server/pm/Settings$PackageState;

    .line 410
    .local v0, "state":Lcom/android/server/pm/Settings$PackageState;
    if-eqz v0, :cond_0

    .line 411
    iget-boolean v1, v0, Lcom/android/server/pm/Settings$PackageState;->stopped:Z

    .line 413
    :cond_0
    const-string v2, "TianynDebugPMW : "

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "getPackageStopSate pkgName:"
...
.method getPackageStoppedStateLPr(Ljava/lang/String;I)Z
    .locals 4
    .param p1, "packageName"    # Ljava/lang/String;
    .param p2, "userId"    # I
...
.method setPackageStopSate(Ljava/lang/String;ZI)V
    .locals 4
    .param p1, "pkgName"    # Ljava/lang/String;
    .param p2, "stopped"    # Z
    .param p3, "userId"    # I
    ...
    .prologue
    .line 397
    const-string v1, "TianynDebugPMW : "

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "setPackageStopSate pkgName:"
    ...
    .line 398
    iget-object v1, p0, Lcom/android/server/pm/Settings;->mStates:Landroid/util/ArrayMap;
    ...
    .line 400
    new-instance v0, Lcom/android/server/pm/Settings$PackageState;

    .end local v0    # "state":Lcom/android/server/pm/Settings$PackageState;
    invoke-direct {v0, p0}, Lcom/android/server/pm/Settings$PackageState;-><init>(Lcom/android/server/pm/Settings;)V

    .line 402
    .restart local v0    # "state":Lcom/android/server/pm/Settings$PackageState;
    :cond_0
    iput-object p1, v0, Lcom/android/server/pm/Settings$PackageState;->pkgName:Ljava/lang/String;

    .line 403
    iput-boolean p2, v0, Lcom/android/server/pm/Settings$PackageState;->stopped:Z
...
.method public setShutDown(Z)V
    ...
    .prologue
    .line 233
    iput-boolean p1, p0, Lcom/android/server/pm/Settings;->mShutDown:Z
...
.method writePackageRestrictionsLPr(I)V
    ...
    invoke-interface {v10, v11, v14}, Lorg/xmlpull/v1/XmlSerializer;->setOutput(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-interface {v10, v14, v15}, Lorg/xmlpull/v1/XmlSerializer;->setFeature(Ljava/lang/String;Z)V
    ...
    iget-object v14, v0, Lcom/android/server/pm/Settings;->mPackages:Landroid/util/ArrayMap;
    ...
    iget-boolean v14, v0, Lcom/android/server/pm/Settings;->mShutDown:Z
    ...
    .line 1806
    .local v9, "pkgState":Lcom/android/server/pm/Settings$PackageState;
    iget-object v14, v8, Lcom/android/server/pm/PackageSetting;->name:Ljava/lang/String;

    if-eqz v14, :cond_4

    .line 1807
    const-string v14, "TianynDebugPMW : "
    ...
    iget-object v14, v0, Lcom/android/server/pm/Settings;->mStates:Landroid/util/ArrayMap;
    ...
    .end local v9    # "pkgState":Lcom/android/server/pm/Settings$PackageState;
    check-cast v9, Lcom/android/server/pm/Settings$PackageState;

    .line 1810
    .restart local v9    # "pkgState":Lcom/android/server/pm/Settings$PackageState;
    :cond_4
    if-eqz v9, :cond_5
    ...
    const-string v16, "pkgName 2 = "

    invoke-virtual/range {v15 .. v16}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v15

    iget-object v0, v9, Lcom/android/server/pm/Settings$PackageState;->pkgName:Ljava/lang/String;
    ...
    .line 1812
    iget-boolean v14, v9, Lcom/android/server/pm/Settings$PackageState;->stopped:Z

    iput-boolean v14, v13, Landroid/content/pm/PackageUserState;->stopped:Z
    ...
    iget-object v14, v13, Landroid/content/pm/PackageUserState;->enabledComponents:Landroid/util/ArraySet;
    ...
    :cond_6
    iget-object v14, v13, Landroid/content/pm/PackageUserState;->disabledComponents:Landroid/util/ArraySet;
    ...
    iget v14, v13, Landroid/content/pm/PackageUserState;->domainVerificationStatus:I
    ...
    const-string v15, "domainVerificationStatus"

    iget v0, v13, Landroid/content/pm/PackageUserState;->domainVerificationStatus:I
    ...
    .line 1859
    :cond_f
    iget v14, v13, Landroid/content/pm/PackageUserState;->appLinkGeneration:I
    ...
    const-string v15, "app-link-generation"

    iget v0, v13, Landroid/content/pm/PackageUserState;->appLinkGeneration:I
    ...
    invoke-interface {v10, v14, v15, v7}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-virtual {v0, v10, v1, v14}, Lcom/android/server/pm/Settings;->writePreferredActivitiesLPr(Lorg/xmlpull/v1/XmlSerializer;IZ)V
    ...
    invoke-virtual {v0, v10, v1}, Lcom/android/server/pm/Settings;->writePersistentPreferredActivitiesLPr(Lorg/xmlpull/v1/XmlSerializer;I)V
    ...
    invoke-virtual {v0, v10, v1}, Lcom/android/server/pm/Settings;->writeCrossProfileIntentFiltersLPr(Lorg/xmlpull/v1/XmlSerializer;I)V
    ...
    invoke-virtual {v0, v10, v1}, Lcom/android/server/pm/Settings;->writeDefaultAppsLPr(Lorg/xmlpull/v1/XmlSerializer;I)V
