...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/BluetoothManagerService$AirplaneModeChangedHandler;
    }
.end annotation
...
.field private static final MESSAGE_AIRPLANE_MODE_CHANGED:I = 0x3e8
...
.field private final mAirplaneModeChangedHandler:Lcom/android/server/BluetoothManagerService$AirplaneModeChangedHandler;

.field private final mAirplaneModeHandlerThread:Landroid/os/HandlerThread;
...
.field private mHandleAirplaneModeOff:Z
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 156
    iput-boolean v5, p0, Lcom/android/server/BluetoothManagerService;->mHandleAirplaneModeOff:Z
    ...
    const-string v4, "BTAirplaneModeThread"

    invoke-direct {v3, v4}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v3, p0, Lcom/android/server/BluetoothManagerService;->mAirplaneModeHandlerThread:Landroid/os/HandlerThread;

    .line 292
    iget-object v3, p0, Lcom/android/server/BluetoothManagerService;->mAirplaneModeHandlerThread:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->start()V

    .line 293
    new-instance v3, Lcom/android/server/BluetoothManagerService$AirplaneModeChangedHandler;

    iget-object v4, p0, Lcom/android/server/BluetoothManagerService;->mAirplaneModeHandlerThread:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v3, p0, v4}, Lcom/android/server/BluetoothManagerService$AirplaneModeChangedHandler;-><init>(Lcom/android/server/BluetoothManagerService;Landroid/os/Looper;)V

    iput-object v3, p0, Lcom/android/server/BluetoothManagerService;->mAirplaneModeChangedHandler:Lcom/android/server/BluetoothManagerService$AirplaneModeChangedHandler;
...
.method static synthetic access$1400(Lcom/android/server/BluetoothManagerService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$200(Lcom/android/server/BluetoothManagerService;)Lcom/android/server/BluetoothManagerService$AirplaneModeChangedHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;

    .prologue
    .line 66
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mAirplaneModeChangedHandler:Lcom/android/server/BluetoothManagerService$AirplaneModeChangedHandler;
...
.method static synthetic access$700(Lcom/android/server/BluetoothManagerService;ZZ)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method static synthetic access$902(Lcom/android/server/BluetoothManagerService;Z)Z
    ...
    .prologue
    .line 66
    iput-boolean p1, p0, Lcom/android/server/BluetoothManagerService;->mHandleAirplaneModeOff:Z
...
.method private canUnbindBluetoothService()Z
    ...
    iget-boolean v3, p0, Lcom/android/server/BluetoothManagerService;->mHandleAirplaneModeOff:Z
...
.method private sendBluetoothServiceUpCallback()V
    ...
    const-string v5, "mCallbacks.getBroadcastItem(i):"
