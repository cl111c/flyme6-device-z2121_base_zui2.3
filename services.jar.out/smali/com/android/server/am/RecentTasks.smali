...
.method trimForTaskLocked(Lcom/android/server/am/TaskRecord;Z)I
    ...
    .line 443
    .local v9, "maxRecents":I
    move-object/from16 v0, p1

    invoke-static {v0, v8}, Lcom/android/server/am/ZuiMMChatPlugin;->getIntentIsMMChat(Lcom/android/server/am/TaskRecord;Landroid/content/Intent;)I

    move-result v7

    .line 444
    .local v7, "iMMChatIntent":I
    if-lez v7, :cond_2

    const/4 v2, 0x1

    .line 445
    .local v2, "bIsIntentMMPkg":Z
    :goto_1
    const/16 v17, 0x3
    ...
    .line 447
    .local v3, "bIsIntentMMWebUIChat":Z
    :goto_2
    const/4 v6, 0x0
    ...
    invoke-virtual {v0, v6}, Lcom/android/server/am/RecentTasks;->get(I)Ljava/lang/Object;
    ...
    .line 439
    .end local v2    # "bIsIntentMMPkg":Z
    .end local v3    # "bIsIntentMMWebUIChat":Z
    .end local v5    # "document":Z
    .end local v6    # "i":I
    .end local v7    # "iMMChatIntent":I
    .end local v9    # "maxRecents":I
    ...
    .line 444
    .restart local v5    # "document":Z
    .restart local v7    # "iMMChatIntent":I
    .restart local v9    # "maxRecents":I
    :cond_2
    const/4 v2, 0x0
    ...
    .line 445
    .restart local v2    # "bIsIntentMMPkg":Z
    :cond_3
    const/4 v3, 0x0
    ...
    .line 453
    .restart local v3    # "bIsIntentMMWebUIChat":Z
    ...
    invoke-virtual {v8, v15}, Landroid/content/Intent;->filterEquals(Landroid/content/Intent;)Z
    ...
    .line 471
    .restart local v4    # "bothDocuments":Z
    :cond_c
    invoke-static {v15}, Lcom/android/server/am/ZuiMMChatPlugin;->isMMChatWebuiIntent(Landroid/content/Intent;)Z
    ...
    invoke-virtual {v0, v6}, Lcom/android/server/am/RecentTasks;->remove(I)Ljava/lang/Object;
