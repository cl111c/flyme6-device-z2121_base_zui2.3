...
.method constructor <init>(Ljava/io/File;Lcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/RecentTasks;)V
    ...
    iput-object v6, p0, Lcom/android/server/am/TaskPersister;->mWriteQueue:Ljava/util/ArrayList;

    .line 123
    new-instance v6, Ljava/io/File;

    const-string v7, "recent_tasks"

    invoke-direct {v6, p1, v7}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    sput-object v6, Lcom/android/server/am/TaskPersister;->sTasksDir:Ljava/io/File;

    .line 124
    sget-object v6, Lcom/android/server/am/TaskPersister;->sTasksDir:Ljava/io/File;
    ...
    const-string v8, "Failure creating tasks directory "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Lcom/android/server/am/TaskPersister;->sTasksDir:Ljava/io/File;
    ...
    const-string v7, "recent_images"

    invoke-direct {v6, p1, v7}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    sput-object v6, Lcom/android/server/am/TaskPersister;->sImagesDir:Ljava/io/File;

    .line 142
    sget-object v6, Lcom/android/server/am/TaskPersister;->sImagesDir:Ljava/io/File;
    ...
    const-string v8, "Failure creating images directory "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Lcom/android/server/am/TaskPersister;->sImagesDir:Ljava/io/File;
    ...
    .line 160
    iget-object v6, p2, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;

    iput-object v6, p0, Lcom/android/server/am/TaskPersister;->mService:Lcom/android/server/am/ActivityManagerService;

    .line 161
    iput-object p3, p0, Lcom/android/server/am/TaskPersister;->mRecentTasks:Lcom/android/server/am/RecentTasks;

    .line 162
    new-instance v6, Lcom/android/server/am/TaskPersister$LazyTaskWriterThread;

    const-string v7, "LazyTaskWriterThread"

    invoke-direct {v6, p0, v7}, Lcom/android/server/am/TaskPersister$LazyTaskWriterThread;-><init>(Lcom/android/server/am/TaskPersister;Ljava/lang/String;)V

    iput-object v6, p0, Lcom/android/server/am/TaskPersister;->mLazyTaskWriterThread:Lcom/android/server/am/TaskPersister$LazyTaskWriterThread;
    ...
    .line 133
    .local v5, "taskFiles":[Ljava/io/File;
    move-object v0, v5
    ...
    .end local v2    # "i$":I
    .end local v4    # "len$":I
    .end local v5    # "taskFiles":[Ljava/io/File;
    :cond_4
    sget-object v6, Lcom/android/server/am/TaskPersister;->sImagesDir:Ljava/io/File;
