...
.method final processNextBroadcast(Z)V
    ...
    iput-boolean v5, v0, Lcom/android/server/am/BroadcastQueue;->mBroadcastsScheduled:Z
    ...
    iget-object v5, v0, Lcom/android/server/am/BroadcastQueue;->mParallelBroadcasts:Ljava/util/ArrayList;
    ...
    iput-wide v14, v0, Lcom/android/server/am/BroadcastRecord;->dispatchTime:J
    ...
    iput-wide v14, v0, Lcom/android/server/am/BroadcastRecord;->dispatchClockTime:J
    ...
    invoke-direct {v0, v1, v2, v5}, Lcom/android/server/am/BroadcastQueue;->deliverToRegisteredReceiverLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;Z)V
    ...
    iget-object v5, v0, Lcom/android/server/am/BroadcastQueue;->mPendingBroadcast:Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v13, v13, Lcom/android/server/am/BroadcastRecord;->curApp:Lcom/android/server/am/ProcessRecord;
    ...
    const-string v13, " died before responding to broadcast"
    ...
    iput v11, v5, Lcom/android/server/am/BroadcastRecord;->state:I
    ...
    iget v11, v0, Lcom/android/server/am/BroadcastQueue;->mPendingBroadcastRecvIndex:I

    iput v11, v5, Lcom/android/server/am/BroadcastRecord;->nextReceiver:I
    ...
    iget-wide v0, v0, Lcom/android/server/am/BroadcastQueue;->mTimeoutPeriod:J
    ...
    const-string v13, "Hung broadcast ["
    ...
    const-string v13, "] discarded after timeout failure:"
    ...
    iget v13, v0, Lcom/android/server/am/BroadcastRecord;->state:I
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/am/BroadcastQueue;->broadcastTimeoutLocked(Z)V
    ...
    iget v5, v0, Lcom/android/server/am/BroadcastRecord;->state:I
    ...
    iget-boolean v5, v0, Lcom/android/server/am/BroadcastQueue;->mPendingBroadcastTimeoutMessage:Z
    ...
    instance-of v5, v0, Lcom/android/server/am/BroadcastFilter;
    ...
    const-string v13, "] sending broadcast result of "
    ...
    iget v5, v0, Lcom/android/server/am/BroadcastFilter;->owningUid:I
    ...
    invoke-virtual {v0, v5, v14, v15, v1}, Lcom/android/server/am/BroadcastQueue;->scheduleTempWhitelistLocked(IJLcom/android/server/am/BroadcastRecord;)V
    ...
    iget-boolean v9, v11, Landroid/content/pm/ActivityInfo;->exported:Z
    ...
    const-string v13, "Permission Denial: broadcasting "
    ...
    const-string v13, " is not exported from uid "
    ...
    const-string v13, " due to receiver "
    ...
    invoke-interface {v5, v0, v11, v13}, Landroid/content/pm/IPackageManager;->checkPermission(Ljava/lang/String;Ljava/lang/String;I)I
    :try_end_8
    ...
    const-string v13, "Permission Denial: receiving "
    ...
    invoke-virtual {v5, v11, v13, v14}, Lcom/android/server/AppOpsService;->noteOperation(IILjava/lang/String;)I
    ...
    const-string v13, "Appop Denial: receiving "
    ...
    const-string v13, " requires appop "
    ...
    iget-object v4, v5, Lcom/android/server/am/ActivityManagerService;->mIntentFirewall:Lcom/android/server/firewall/IntentFirewall;
    ...
    invoke-virtual {v5, v11, v13, v14, v15}, Lcom/android/server/am/ActivityManagerService;->isSingleton(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;I)Z
    :try_end_a
    ...
    invoke-static {v5, v11}, Landroid/app/ActivityManager;->checkUidPermission(Ljava/lang/String;I)I
    ...
    const-string v13, "Permission Denial: Receiver "
    ...
    const-string v13, " requests FLAG_SINGLE_USER, but app does not hold "
    ...
    const-string v13, "Skipping deliver ordered ["
    ...
    iget-object v13, v0, Lcom/android/server/am/BroadcastRecord;->curApp:Lcom/android/server/am/ProcessRecord;

    invoke-virtual {v11, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v13, ": process crashing"
    ...
    invoke-interface {v5, v11, v13}, Landroid/content/pm/IPackageManager;->isPackageAvailable(Ljava/lang/String;I)Z
    :try_end_c
    ...
    iput-object v5, v0, Lcom/android/server/am/BroadcastRecord;->curFilter:Lcom/android/server/am/BroadcastFilter;
    ...
    iget-object v13, v13, Landroid/content/pm/ActivityInfo;->permission:Ljava/lang/String;
    ...
    iget-object v12, v5, Landroid/content/pm/ActivityInfo;->processName:Ljava/lang/String;

    .line 1023
    .local v12, "targetProcess":Ljava/lang/String;
    move-object/from16 v0, v24
    ...
    invoke-virtual {v5, v11, v0}, Lcom/android/server/am/ActivityManagerService;->isValidSingletonCall(II)Z
    ...
    invoke-virtual {v5, v11, v13}, Lcom/android/server/am/ActivityManagerService;->getActivityInfoForUser(Landroid/content/pm/ActivityInfo;I)Landroid/content/pm/ActivityInfo;
    ...
    iput-object v5, v0, Lcom/android/server/am/BroadcastRecord;->curReceiver:Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v0, v1, v14, v15, v2}, Lcom/android/server/am/BroadcastQueue;->scheduleTempWhitelistLocked(IJLcom/android/server/am/BroadcastRecord;)V
    :try_end_d
    ...
    invoke-interface {v5, v11, v13, v14}, Landroid/content/pm/IPackageManager;->setPackageStoppedState(Ljava/lang/String;ZI)V
    :try_end_e
    ...
    invoke-virtual {v5, v12, v11, v13}, Lcom/android/server/am/ActivityManagerService;->getProcessRecordLocked(Ljava/lang/String;IZ)Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {v0, v5, v11, v13}, Lcom/android/server/am/ProcessRecord;->addPackage(Ljava/lang/String;ILcom/android/server/am/ProcessStatsService;)Z
    ...
    const-string v13, "Failed trying to unstop package "
    ...
    const-string v13, "Exception when sending broadcast to "
    ...
    :goto_f
    new-instance v4, Lcom/android/server/am/BroadcastQueue$1;

    move-object/from16 v5, p0

    invoke-direct/range {v4 .. v10}, Lcom/android/server/am/BroadcastQueue$1;-><init>(Lcom/android/server/am/BroadcastQueue;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v13, v5, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    const-string v13, " for broadcast "
    ...
    const-string v13, ": process is bad"
    ...
    invoke-virtual/range {v13 .. v19}, Lcom/android/server/am/BroadcastQueue;->finishReceiverLocked(Lcom/android/server/am/BroadcastRecord;ILjava/lang/String;Landroid/os/Bundle;ZZ)Z
    ...
    .end local v6    # "srcUid":I
    .end local v7    # "targeUid":I
    ...
    const-string v13, "Failed sending broadcast to "
    ...
    invoke-static {v5, v11, v0}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    .restart local v6    # "srcUid":I
    .restart local v7    # "targeUid":I
    .restart local v8    # "process":Ljava/lang/String;
    ...
    .restart local v10    # "targetClass":Ljava/lang/String;
    :cond_26
    const/16 v18, 0x0
