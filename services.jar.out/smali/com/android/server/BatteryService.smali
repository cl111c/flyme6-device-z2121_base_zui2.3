...
.field private mXuiBatteryService:Lcom/android/server/XuiBatteryService;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 165
    new-instance v0, Lcom/android/server/XuiBatteryService;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/XuiBatteryService;-><init>(Landroid/content/Context;Lcom/android/server/BatteryService$Led;Landroid/os/Handler;Lcom/android/internal/app/IBatteryStats;Ljava/lang/Object;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mXuiBatteryService:Lcom/android/server/XuiBatteryService;
    ...
    .line 183
    :cond_0
    new-instance v0, Lcom/android/server/XuiLinearMotorStateObserver;

    iget-object v1, p0, Lcom/android/server/BatteryService;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/BatteryService;->mHandler:Landroid/os/Handler;

    invoke-direct {v0, v1, v2}, Lcom/android/server/XuiLinearMotorStateObserver;-><init>(Landroid/content/Context;Landroid/os/Handler;)V
...
.method static synthetic access$900(Lcom/android/server/BatteryService;)Lcom/android/server/XuiBatteryService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BatteryService;

    .prologue
    .line 94
    iget-object v0, p0, Lcom/android/server/BatteryService;->mXuiBatteryService:Lcom/android/server/XuiBatteryService;
...
.method private processValuesLocked(Z)V
    ...
    const-string v2, ", maxChargingCurrent"
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/server/XuiBatteryService;->processValuesLocked(IIILandroid/os/BatteryProperties;)V
...
.method private sendIntentLocked()V
    ...
    const-string v4, ", maxChargingCurrent:"
...
.method public onBootPhase(I)V
    ...
    .line 222
    iget-object v2, p0, Lcom/android/server/BatteryService;->mXuiBatteryService:Lcom/android/server/XuiBatteryService;

    invoke-virtual {v2}, Lcom/android/server/XuiBatteryService;->setupContentObserver()V
