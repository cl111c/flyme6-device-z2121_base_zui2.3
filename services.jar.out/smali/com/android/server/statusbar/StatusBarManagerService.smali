...
.method public isTaskFullscreen(I)Z
    .locals 1
    .param p1, "taskId"    # I
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/WindowManagerService;->isTaskFullscreen(I)Z
...
.method public monitorInput(Ljava/lang/String;Landroid/view/InputChannel;)V
    .locals 2
    .param p1, "strName"    # Ljava/lang/String;
    .param p2, "outChannel"    # Landroid/view/InputChannel;
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/WindowManagerService;->monitorInput(Ljava/lang/String;)Landroid/view/InputChannel;

    move-result-object v0

    .line 842
    .local v0, "pannel":Landroid/view/InputChannel;
    if-eqz v0, :cond_0

    invoke-virtual {v0, p2}, Landroid/view/InputChannel;->transferTo(Landroid/view/InputChannel;)V

    .line 844
    .end local v0    # "pannel":Landroid/view/InputChannel;
    :cond_0
    return-void
.end method
