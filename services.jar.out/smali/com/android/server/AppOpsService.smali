...
.field static final DEBUG_MORE:Z = false

.field static final DEFAULT_POLICY_FILE:Ljava/lang/String; = "/system/etc/appops_policy.xml"

.field static final DIALOG_SHOW_MIN_SLOT:J = 0x1b7740L

.field static final TAG:Ljava/lang/String; = "AppOps"

.field private static final WHITE_LIST_FOR_BOOT_COMPLETED:[Ljava/lang/String;

.field private static final WHITE_LIST_FOR_GET_USAGE_STATS:[Ljava/lang/String;
...
.field mAvoidDeadLock:Ljava/lang/Object;
...
.field mShenqiPolicy:Landroid/app/ShenqiOpsPolicy;

.field final mStrictEnable:Z

.field final mTimerConditionRunner:Ljava/lang/Runnable;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "com.zui.sdac"

    aput-object v1, v0, v3

    sput-object v0, Lcom/android/server/AppOpsService;->WHITE_LIST_FOR_GET_USAGE_STATS:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/AppOpsService;->WHITE_LIST_FOR_BOOT_COMPLETED:[Ljava/lang/String;
...
.method public constructor <init>(Ljava/io/File;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/android/server/AppOpsService;->mActivityManager:Landroid/app/IActivityManager;

    .line 96
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/AppOpsService;->timerCondition:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/AppOpsService;->mIsRow:Z
    ...
    iput-object v0, p0, Lcom/android/server/AppOpsService;->mAvoidDeadLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/android/server/AppOpsService;->mTimerConditionRunner:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/server/AppOpsService;->mHandlerThread:Landroid/os/HandlerThread;

    .line 282
    iget-object v0, p0, Lcom/android/server/AppOpsService;->mHandlerThread:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lcom/android/server/AppOpsService;->mHandlerThread:Landroid/os/HandlerThread;
...
.method static synthetic access$100(Lcom/android/server/AppOpsService;IILjava/lang/String;I)V
    .locals 0
    ...
    .prologue
    .line 90
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/server/AppOpsService;->checkAndSetAliasMode(IILjava/lang/String;I)V
...
.method private askOperationLocked(IILjava/lang/String;Lcom/android/server/AppOpsService$Op;Z)Lcom/android/server/PermissionDialogReqQueue$PermissionDialogReq;
    .locals 9
    .param p1, "code"    # I
    .param p2, "uid"    # I
    .param p3, "packageName"    # Ljava/lang/String;
    .param p4, "op"    # Lcom/android/server/AppOpsService$Op;
    .param p5, "suggestDialog"    # Z
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/server/AppOpsService$AskRunnable;-><init>(Lcom/android/server/AppOpsService;IILjava/lang/String;Lcom/android/server/AppOpsService$Op;Lcom/android/server/PermissionDialogReqQueue$PermissionDialogReq;Z)V
...
.method private checkAndSetAliasMode(IILjava/lang/String;I)V
    .locals 7
    .param p1, "code"    # I
    .param p2, "uid"    # I
    .param p3, "packageName"    # Ljava/lang/String;
    ...
    const-string v6, "in check and set alias mode code:"
    ...
    .line 2170
    .local v2, "switchOp":I
    iget-object v4, p0, Lcom/android/server/AppOpsService;->mShenqiPolicy:Landroid/app/ShenqiOpsPolicy;

    invoke-virtual {v4, v2}, Landroid/app/ShenqiOpsPolicy;->getOpCodeAlias(I)[I
    ...
    .line 2175
    invoke-virtual {p0, v3, p2, p3}, Lcom/android/server/AppOpsService;->checkOperation(IILjava/lang/String;)I
    ...
    .line 2177
    invoke-virtual {p0, v3, p2, p3, p4}, Lcom/android/server/AppOpsService;->setMode(IILjava/lang/String;I)V
...
.method private getDefaultMode(IILjava/lang/String;)I
    ...
    :cond_0
    iget-boolean v2, p0, Lcom/android/server/AppOpsService;->mIsRow:Z

    if-nez v2, :cond_1

    iget-object v2, p0, Lcom/android/server/AppOpsService;->mShenqiPolicy:Landroid/app/ShenqiOpsPolicy;
    ...
    invoke-virtual {v2, p1, v0, p3}, Landroid/app/ShenqiOpsPolicy;->getDefaultMode(IILjava/lang/String;)I
...
.method private noteOperationUnchecked(IILjava/lang/String;ILjava/lang/String;)I
    ...
    .line 1052
    sget-object v10, Lcom/android/server/AppOpsService;->WHITE_LIST_FOR_BOOT_COMPLETED:[Ljava/lang/String;
    ...
    .line 1053
    .local v19, "whiteItem":Ljava/lang/String;
    ...
    .end local v11    # "i$":I
    .end local v12    # "len$":I
    .end local v19    # "whiteItem":Ljava/lang/String;
    :goto_1
    return v17
    ...
    .restart local v19    # "whiteItem":Ljava/lang/String;
    :cond_0
    add-int/lit8 v11, v11, 0x1
    ...
    invoke-direct {v0, v14, v1, v4}, Lcom/android/server/AppOpsService;->getOpLocked(Lcom/android/server/AppOpsService$Ops;IZ)Lcom/android/server/AppOpsService$Op;
    ...
    .line 1070
    :cond_3
    iget v4, v13, Lcom/android/server/AppOpsService$Op;->duration:I
    ...
    iget-wide v6, v13, Lcom/android/server/AppOpsService$Op;->time:J
    ...
    iget v6, v13, Lcom/android/server/AppOpsService$Op;->duration:I
    ...
    iput v4, v13, Lcom/android/server/AppOpsService$Op;->duration:I
    ...
    iput-wide v4, v13, Lcom/android/server/AppOpsService$Op;->rejectTime:J
    ...
    iput-wide v4, v13, Lcom/android/server/AppOpsService$Op;->time:J
    ...
    iget-object v5, v0, Lcom/android/server/AppOpsService;->mLooper:Landroid/os/Looper;
    ...
    .line 1114
    :cond_9
    iget v4, v13, Lcom/android/server/AppOpsService$Op;->noteOpCount:I

    add-int/lit8 v4, v4, 0x1

    iput v4, v13, Lcom/android/server/AppOpsService$Op;->noteOpCount:I
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/AppOpsService;->askOperationLocked(IILjava/lang/String;Lcom/android/server/AppOpsService$Op;Z)Lcom/android/server/PermissionDialogReqQueue$PermissionDialogReq;

    move-result-object v15

    .line 1119
    .local v15, "req":Lcom/android/server/PermissionDialogReqQueue$PermissionDialogReq;
    monitor-exit p0
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 1120
    invoke-virtual {v15}, Lcom/android/server/PermissionDialogReqQueue$PermissionDialogReq;->get()I
...
.method private readPolicy()V
    ...
    .line 2205
    :goto_0
    new-instance v0, Landroid/app/ShenqiOpsPolicy;

    iget-object v1, p0, Lcom/android/server/AppOpsService;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Landroid/app/ShenqiOpsPolicy;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/AppOpsService;->mShenqiPolicy:Landroid/app/ShenqiOpsPolicy;

    .line 2206
    iget-object v0, p0, Lcom/android/server/AppOpsService;->mShenqiPolicy:Landroid/app/ShenqiOpsPolicy;

    invoke-virtual {v0}, Landroid/app/ShenqiOpsPolicy;->startWathcingPolicyFile()V
...
.method public checkOperation(IILjava/lang/String;)I
    ...
    .line 925
    sget-object v0, Lcom/android/server/AppOpsService;->WHITE_LIST_FOR_GET_USAGE_STATS:[Ljava/lang/String;
    ...
    .restart local v6    # "whiteItem":Ljava/lang/String;
    :cond_1
    add-int/lit8 v1, v1, 0x1
    ...
    .line 933
    sget-object v0, Lcom/android/server/AppOpsService;->WHITE_LIST_FOR_BOOT_COMPLETED:[Ljava/lang/String;
    ...
    invoke-direct {p0, p2, v7}, Lcom/android/server/AppOpsService;->getUidStateLocked(IZ)Lcom/android/server/AppOpsService$UidState;
    ...
    iget-object v7, v5, Lcom/android/server/AppOpsService$UidState;->opModes:Landroid/util/SparseIntArray;
...
.method public notifyOperation(IILjava/lang/String;IZ)V
    ...
    iput-boolean v4, v0, Lcom/android/server/AppOpsService;->timerCondition:Z

    .line 2102
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/AppOpsService;->mHandler:Landroid/os/Handler;

    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/server/AppOpsService;->mTimerConditionRunner:Ljava/lang/Runnable;
    ...
    .line 2109
    .local v15, "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    invoke-static/range {p1 .. p1}, Landroid/app/AppOpsManager;->opToSwitch(I)I
    ...
    .line 2113
    .local v14, "op":Lcom/android/server/AppOpsService$Op;
    if-eqz v14, :cond_4

    .line 2115
    iget-object v4, v14, Lcom/android/server/AppOpsService$Op;->dialogReqQueue:Lcom/android/server/PermissionDialogReqQueue;

    invoke-virtual {v4}, Lcom/android/server/PermissionDialogReqQueue;->getDialog()Lcom/android/server/PermissionDialog;
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/PermissionDialogReqQueue;->notifyAll(I)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/PermissionDialogReqQueue;->setDialog(Lcom/android/server/PermissionDialog;)V
    ...
    .line 2123
    .local v13, "cbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    if-eqz v13, :cond_2
    ...
    .end local v15    # "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    .local v16, "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    move-object/from16 v15, v16

    .line 2127
    .end local v16    # "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    .restart local v15    # "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    :cond_1
    ...
    .line 2129
    .end local v15    # "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    .restart local v16    # "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    :try_start_1
    move-object/from16 v0, p0
    ...
    .end local v13    # "cbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    check-cast v13, Ljava/util/ArrayList;

    .line 2130
    .restart local v13    # "cbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    if-eqz v13, :cond_6
    ...
    .line 2146
    .local v7, "mRepCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    move/from16 v10, p1
    ...
    .line 2151
    .local v8, "mSwitchCode":I
    new-instance v4, Lcom/android/server/AppOpsService$4;

    const-string v6, "callback"

    move-object/from16 v5, p0

    invoke-direct/range {v4 .. v12}, Lcom/android/server/AppOpsService$4;-><init>(Lcom/android/server/AppOpsService;Ljava/lang/String;Ljava/util/ArrayList;ILjava/lang/String;III)V

    invoke-virtual {v4}, Lcom/android/server/AppOpsService$4;->start()V

    .line 2165
    return-void

    .line 2144
    .end local v7    # "mRepCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    .end local v8    # "mSwitchCode":I
    .end local v9    # "mPackageName":Ljava/lang/String;
    .end local v10    # "mCode":I
    .end local v11    # "mUid":I
    .end local v12    # "mMode":I
    .end local v14    # "op":Lcom/android/server/AppOpsService$Op;
    :catchall_0
    move-exception v4
    ...
    .end local v15    # "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    .restart local v14    # "op":Lcom/android/server/AppOpsService$Op;
    .restart local v16    # "repCbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AppOpsService$Callback;>;"
    :catchall_1
    move-exception v4
...
.method readUid(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)V
    ...
    const-string v25, "Could not contact PackageManager"
    ...
    const-string v26, "Unknown element under <pkg>: "
...
.method public setMode(IILjava/lang/String;I)V
    ...
    iput-boolean v12, v0, Lcom/android/server/AppOpsService;->timerCondition:Z

    .line 641
    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/server/AppOpsService;->mHandler:Landroid/os/Handler;

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/AppOpsService;->mTimerConditionRunner:Ljava/lang/Runnable;
...
.method public startOperation(Landroid/os/IBinder;IILjava/lang/String;)I
    ...
    .line 1132
    check-cast v10, Lcom/android/server/AppOpsService$ClientState;

    .line 1133
    .local v10, "client":Lcom/android/server/AppOpsService$ClientState;
    monitor-enter p0
    ...
    invoke-direct {v0, v13, v1, v4}, Lcom/android/server/AppOpsService;->getOpLocked(Lcom/android/server/AppOpsService$Ops;IZ)Lcom/android/server/AppOpsService$Op;
    ...
    iget-object v0, v13, Lcom/android/server/AppOpsService$Ops;->uidState:Lcom/android/server/AppOpsService$UidState;

    move-object/from16 v17, v0

    .line 1146
    .local v17, "uidState":Lcom/android/server/AppOpsService$UidState;
    ...
    iput-wide v4, v12, Lcom/android/server/AppOpsService$Op;->rejectTime:J
    ...
    invoke-direct {v0, v13, v15, v4}, Lcom/android/server/AppOpsService;->getOpLocked(Lcom/android/server/AppOpsService$Ops;IZ)Lcom/android/server/AppOpsService$Op;
    ...
    .line 1167
    iget v4, v12, Lcom/android/server/AppOpsService$Op;->nesting:I
    ...
    iput-wide v4, v12, Lcom/android/server/AppOpsService$Op;->time:J
    ...
    iput v4, v12, Lcom/android/server/AppOpsService$Op;->duration:I
    ...
    iput v4, v12, Lcom/android/server/AppOpsService$Op;->nesting:I

    .line 1173
    iget-object v4, v10, Lcom/android/server/AppOpsService$ClientState;->mStartedOps:Ljava/util/ArrayList;
    ...
    const-string v6, "startOperation: This method will deadlock if called from the main thread. (Code: "
    ...
    .line 1188
    :cond_8
    iget v4, v12, Lcom/android/server/AppOpsService$Op;->startOpCount:I

    add-int/lit8 v4, v4, 0x1

    iput v4, v12, Lcom/android/server/AppOpsService$Op;->startOpCount:I

    .line 1189
    iget-object v11, v10, Lcom/android/server/AppOpsService$ClientState;->mAppToken:Landroid/os/IBinder;

    .line 1190
    .local v11, "clientToken":Landroid/os/IBinder;
    iget-object v4, v12, Lcom/android/server/AppOpsService$Op;->clientTokens:Ljava/util/ArrayList;
    ...
    .line 1195
    .local v14, "req":Lcom/android/server/PermissionDialogReqQueue$PermissionDialogReq;
    monitor-exit p0
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 1196
    invoke-virtual {v14}, Lcom/android/server/PermissionDialogReqQueue$PermissionDialogReq;->get()I
