...
.field private static final WHITE_LIST_FOR_OP_VIBRATE:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    const-string v2, "com.zui.factorymode"

    aput-object v2, v0, v1

    const/4 v1, 0x5

    const-string v2, "com.lenovo.lenovoautotest"
    ...
    sput-object v0, Lcom/android/server/VibratorService;->WHITE_LIST_FOR_OP_VIBRATE:[Ljava/lang/String;
...
.method private startVibrationLocked(Lcom/android/server/VibratorService$Vibration;)V
    ...
    .line 473
    :try_start_0
    iget-boolean v6, p0, Lcom/android/server/VibratorService;->mLowPowerMode:Z
    ...
    .line 478
    :cond_1
    iget-object v6, p0, Lcom/android/server/VibratorService;->mAppOpsService:Lcom/android/internal/app/IAppOpsService;
    ...
    invoke-interface {v6, v7, v8, v9, v10}, Lcom/android/internal/app/IAppOpsService;->checkAudioOperation(IIILjava/lang/String;)I
    ...
    iget-object v7, p0, Lcom/android/server/VibratorService;->mAppOpsService:Lcom/android/internal/app/IAppOpsService;
    ...
    invoke-interface {v6, v7, v8, v9, v10}, Lcom/android/internal/app/IAppOpsService;->startOperation(Landroid/os/IBinder;IILjava/lang/String;)I
    ...
    .local v5, "userDeny":Z
    :cond_3
    sget-object v0, Lcom/android/server/VibratorService;->WHITE_LIST_FOR_OP_VIBRATE:[Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/android/server/VibratorService;->mVibrationRunnable:Ljava/lang/Runnable;
    ...
    invoke-direct {p0, v6, v7, v8, v9}, Lcom/android/server/VibratorService;->doVibratorOn(JII)V
    ...
    .line 513
    :cond_9
    new-instance v6, Lcom/android/server/VibratorService$VibrateThread;

    invoke-direct {v6, p0, p1}, Lcom/android/server/VibratorService$VibrateThread;-><init>(Lcom/android/server/VibratorService;Lcom/android/server/VibratorService$Vibration;)V

    iput-object v6, p0, Lcom/android/server/VibratorService;->mThread:Lcom/android/server/VibratorService$VibrateThread;

    .line 514
    iget-object v6, p0, Lcom/android/server/VibratorService;->mThread:Lcom/android/server/VibratorService$VibrateThread;

    invoke-virtual {v6}, Lcom/android/server/VibratorService$VibrateThread;->start()V
...
.method private updateInputDeviceVibrators()V
    ...
    invoke-virtual {v4, p0, v7}, Landroid/hardware/input/InputManager;->registerInputDeviceListener(Landroid/hardware/input/InputManager$InputDeviceListener;Landroid/os/Handler;)V
    ...
    invoke-virtual {v4, v7}, Landroid/hardware/input/InputManager;->getInputDevice(I)Landroid/view/InputDevice;
