...
.field private mNewIpSet:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet",
            "<",
...
.field private mOldIpSet:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet",
            "<",
...
.field private mUidIfaceMap:Ljava/util/HashMap;
    .annotation build Lcom/android/internal/annotations/GuardedBy;
        value = "mQuotaLock"
    .end annotation
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mUidIfaceMap:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mOldIpSet:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mNewIpSet:Ljava/util/HashSet;
...
.method private checkAndSetRange()V
    .locals 7

    .prologue
    .line 2785
    iget-object v4, p0, Lcom/android/server/NetworkManagementService;->mNewIpSet:Ljava/util/HashSet;
    ...
    .line 2787
    .local v3, "tmpNewIpSet":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    iget-object v4, p0, Lcom/android/server/NetworkManagementService;->mOldIpSet:Ljava/util/HashSet;
    ...
    const-string v6, "[ZUK] should add ranges:"
    ...
    .line 2792
    .local v2, "ranges":[Ljava/lang/String;
    const/4 v4, 0x1

    invoke-direct {p0, v4, v2}, Lcom/android/server/NetworkManagementService;->setBoostRange(Z[Ljava/lang/String;)V

    .line 2795
    .end local v2    # "ranges":[Ljava/lang/String;
    :cond_1
    iget-object v4, p0, Lcom/android/server/NetworkManagementService;->mOldIpSet:Ljava/util/HashSet;

    iget-object v5, p0, Lcom/android/server/NetworkManagementService;->mNewIpSet:Ljava/util/HashSet;

    invoke-virtual {v4, v5}, Ljava/util/HashSet;->removeAll(Ljava/util/Collection;)Z
    ...
    const-string v6, "[ZUK] should remove ranges:"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/android/server/NetworkManagementService;->mOldIpSet:Ljava/util/HashSet;
    ...
    iget-object v5, p0, Lcom/android/server/NetworkManagementService;->mOldIpSet:Ljava/util/HashSet;
    ...
    .line 2800
    .restart local v2    # "ranges":[Ljava/lang/String;
    const/4 v4, 0x0
    ...
    iput-object v4, p0, Lcom/android/server/NetworkManagementService;->mOldIpSet:Ljava/util/HashSet;
...
.method private prepareNativeDaemon()V
    ...
    const-string v20, "/proc/net/xt_qtaguid/ctrl"
    ...
    const-string v20, "enabling bandwidth control"
    ...
    .line 583
    :goto_0
    const-string v20, "net.qtaguid_enabled"
    ...
    invoke-interface/range {v19 .. v19}, Lcom/android/internal/app/IBatteryStats;->noteNetworkStatsEnabled()V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_2
    ...
    const-string v22, " active quota rules"
    ...
    const-string v20, "problem enabling bandwidth controls"
    ...
    const-string v20, "not enabling bandwidth control"
    ...
    const-string v20, "Failed strict enable"
    ...
    const-string v22, " active alert rules"
    ...
    const-string v22, " active UID rules"
    ...
    const-string v22, " active UID cleartext policies"
    ...
    .line 637
    invoke-virtual {v12, v9}, Landroid/util/SparseIntArray;->keyAt(I)I
    ...
    iget-object v0, v0, Lcom/android/server/NetworkManagementService;->mUidIfaceMap:Ljava/util/HashMap;

    move-object/from16 v16, v0

    .line 645
    .local v16, "uidIfaceMap":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    const/4 v14, 0x0
    ...
    .line 647
    .local v17, "uidKey":Ljava/lang/String;
    const/4 v11, 0x0
    ...
    iput-object v0, v1, Lcom/android/server/NetworkManagementService;->mUidIfaceMap:Ljava/util/HashMap;
    ...
    const-string v22, " active firewall UID rules"
    ...
    .line 654
    .local v15, "uidFirewallRules":Landroid/util/SparseIntArray;
    new-instance v19, Landroid/util/SparseIntArray;
    ...
    .line 656
    invoke-virtual {v15, v9}, Landroid/util/SparseIntArray;->keyAt(I)I
    ...
    const-string v22, "Uid Iface map uid:"
    ...
    invoke-direct {v0, v1, v14, v11, v2}, Lcom/android/server/NetworkManagementService;->setFirewallUidRuleInternal(IILjava/lang/String;I)V
    ...
    .end local v11    # "iface":Ljava/lang/String;
    .end local v14    # "uid":I
    .end local v15    # "uidFirewallRules":Landroid/util/SparseIntArray;
    .end local v16    # "uidIfaceMap":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v17    # "uidKey":Ljava/lang/String;
    :cond_9
    const/16 v19, 0x0
    ...
    .restart local v16    # "uidIfaceMap":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    .restart local v17    # "uidKey":Ljava/lang/String;
    :cond_a
    move-object/from16 v0, p0
    ...
    const-string v22, " active firewall standby UID rules"
    ...
    .line 671
    .restart local v15    # "uidFirewallRules":Landroid/util/SparseIntArray;
    new-instance v19, Landroid/util/SparseIntArray;
    ...
    invoke-virtual/range {v19 .. v20}, Landroid/util/SparseBooleanArray;->get(I)Z
    ...
    const-string v22, " active firewall dozable UID rules"
...
.method private setBoostRange(Z[Ljava/lang/String;)V
    .locals 10
    .param p1, "on"    # Z
    .param p2, "addrRange"    # [Ljava/lang/String;
...
.method private setFirewallUidRuleInternal(IILjava/lang/String;I)V
    .locals 15
    .param p1, "chain"    # I
    .param p2, "uid"    # I
    .param p3, "iface"    # Ljava/lang/String;
    ...
    .prologue
    .line 2270
    iget-object v10, p0, Lcom/android/server/NetworkManagementService;->mQuotaLock:Ljava/lang/Object;

    monitor-enter v10

    .line 2271
    :try_start_0
    invoke-direct/range {p0 .. p1}, Lcom/android/server/NetworkManagementService;->getUidFirewallRules(I)Landroid/util/SparseIntArray;

    move-result-object v7

    .line 2272
    .local v7, "uidFirewallRules":Landroid/util/SparseIntArray;
    iget-object v9, p0, Lcom/android/server/NetworkManagementService;->mUidIfaceMap:Ljava/util/HashMap;
    ...
    .line 2273
    .local v3, "oldIface":Ljava/lang/String;
    const/4 v9, 0x0
    ...
    .line 2274
    .local v5, "oldUidFirewallRule":I
    sget-boolean v9, Lcom/android/server/NetworkManagementService;->DBG:Z
    ...
    const-string v11, "!!!!! Skipping change"
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/NetworkManagementService;->getFirewallRuleName(II)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v5}, Lcom/android/server/NetworkManagementService;->getFirewallRuleName(II)Ljava/lang/String;
    ...
    .line 2290
    .local v8, "uidKey":Ljava/lang/String;
    if-nez p4, :cond_6

    .line 2291
    move/from16 v0, p2

    invoke-virtual {v7, v0}, Landroid/util/SparseIntArray;->delete(I)V
    ...
    const-string v14, "set_uid_iface_rule"

    aput-object v14, v12, v13

    const/4 v13, 0x1

    invoke-virtual/range {p0 .. p1}, Lcom/android/server/NetworkManagementService;->getFirewallChainName(I)Ljava/lang/String;
    ...
    invoke-virtual {v9, v11, v12}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    :try_end_1
    ...
    .end local v3    # "oldIface":Ljava/lang/String;
    .end local v4    # "oldRuleName":Ljava/lang/String;
    .end local v5    # "oldUidFirewallRule":I
    .end local v6    # "ruleName":Ljava/lang/String;
    .end local v7    # "uidFirewallRules":Landroid/util/SparseIntArray;
    .end local v8    # "uidKey":Ljava/lang/String;
    :catchall_0
    move-exception v9
    ...
    .line 2295
    .restart local v3    # "oldIface":Ljava/lang/String;
    .restart local v4    # "oldRuleName":Ljava/lang/String;
    .restart local v5    # "oldUidFirewallRule":I
    .restart local v6    # "ruleName":Ljava/lang/String;
    .restart local v7    # "uidFirewallRules":Landroid/util/SparseIntArray;
    .restart local v8    # "uidKey":Ljava/lang/String;
    :cond_6
    :try_start_3
    move/from16 v0, p2
...
.method private updateNewIpSet([Ljava/lang/String;)V
    .locals 7
    ...
    const-string v6, "[ZUK] updateNewIpSet, address:"
...
.method public setFirewallChainUidIfaceRule(IILjava/lang/String;I)V
    .locals 0
    .param p1, "chain"    # I
    .param p2, "uid"    # I
    .param p3, "iface"    # Ljava/lang/String;
    ...
    .line 2266
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/server/NetworkManagementService;->setFirewallUidRuleInternal(IILjava/lang/String;I)V

    .line 2267
    return-void
.end method

.method public setFirewallChainUidIfaceRules(I[I[Ljava/lang/String;[I)V
    .locals 11
    .param p1, "chain"    # I
    .param p2, "uids"    # [I
    .param p3, "ifaces"    # [Ljava/lang/String;
    .param p4, "rules"    # [I
    ...
    invoke-virtual {p0, p1, v5, v0, v3}, Lcom/android/server/NetworkManagementService;->setFirewallChainUidIfaceRule(IILjava/lang/String;I)V
    ...
    .line 2243
    .restart local v5    # "uid":I
    iget-object v7, p0, Lcom/android/server/NetworkManagementService;->mUidIfaceMap:Ljava/util/HashMap;
    ...
    const-string v10, "Uid Iface map uid:"
    ...
    invoke-direct {p0, p1, v5, v0, v7}, Lcom/android/server/NetworkManagementService;->setFirewallUidRuleInternal(IILjava/lang/String;I)V
...
.method public setFirewallUidIfaceRule(ILjava/lang/String;Z)V
    .locals 2
    .param p1, "uid"    # I
    .param p2, "iface"    # Ljava/lang/String;
    .param p3, "allow"    # Z
    ...
    invoke-direct {p0, v1, p1, p2, v0}, Lcom/android/server/NetworkManagementService;->setFirewallUidRuleInternal(IILjava/lang/String;I)V
...
.method public setFirewallUidIfaceRules([I[Ljava/lang/String;[I)V
    .locals 1
    .param p1, "uids"    # [I
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, Lcom/android/server/NetworkManagementService;->setFirewallChainUidIfaceRules(I[I[Ljava/lang/String;[I)V
...
.method public setFirewallUidRule(III)V
    ...
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/android/server/NetworkManagementService;->setFirewallUidRuleInternal(IILjava/lang/String;I)V
...
.method public setFirewallUidRules(I[I[I)V
    ...
    invoke-direct {p0, p1, v4, v6, v8}, Lcom/android/server/NetworkManagementService;->setFirewallUidRuleInternal(IILjava/lang/String;I)V
...
.method public setIpRange([Ljava/lang/String;)V
    .locals 0
    .param p1, "addrRange"    # [Ljava/lang/String;

    .prologue
    .line 2755
    invoke-direct {p0, p1}, Lcom/android/server/NetworkManagementService;->updateNewIpSet([Ljava/lang/String;)V

    .line 2756
    invoke-direct {p0}, Lcom/android/server/NetworkManagementService;->checkAndSetRange()V
