...
.field private static final DEBUG_MTP:Z = true
...
.field private static final XUI_STORAGE_PARENT_WHERE:Ljava/lang/String; = "storage_id=? AND _data like ?  AND  substr(_data,length(?)) not like ? "
...
.method private createObjectQuery(III)Landroid/database/Cursor;
    ...
    invoke-direct {p0, v0}, Landroid/mtp/MtpDatabase;->getAbsolutePathByID(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    .line 480
    .local v8, "dirPath":Ljava/lang/String;
    const-string/jumbo v4, "storage_id=? AND _data like ?  AND  substr(_data,length(?)) not like ? "
...
.method private getAbsolutePathByID(Ljava/lang/String;)Ljava/lang/String;
    .locals 18
    ...
    iget-object v4, v0, Landroid/mtp/MtpDatabase;->mContext:Landroid/content/Context;
    ...
    .line 1140
    .local v11, "idValue":Ljava/lang/String;
    const/4 v9, 0x0
    ...
    const-string v16, "getAbsolutePathByID:  took "
...
.method private getObjectReferences(I)[I
    ...
    const-string v3, "getObjectReferences():   uri: "
