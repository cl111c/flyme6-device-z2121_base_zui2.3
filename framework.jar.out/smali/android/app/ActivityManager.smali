...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/app/ActivityManager$ProcessStateListener;,
...
.method public appTaskMoveBack(I)V
    .locals 2
    .param p1, "taskid"    # I
    ...
    invoke-interface {v1, p1}, Landroid/app/IActivityManager;->appTaskMoveBack(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public appTaskRemove(I)Z
    .locals 1
    .param p1, "uid"    # I
    ...
    invoke-interface {v0, p1}, Landroid/app/IActivityManager;->appTaskRemove(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getForegroundApplication()Ljava/lang/String;
    .locals 3
    ...
    invoke-interface {v2}, Landroid/app/IActivityManager;->getForegroundApplication()Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isFullScreenActivity(ILjava/lang/String;)Z
    .locals 1
    .param p1, "taskid"    # I
    ...
    invoke-interface {v0, p1, p2}, Landroid/app/IActivityManager;->isFullScreenActivity(ILjava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isLowRamDevice()Z
    ...
    .line 517
    .local v2, "item":Ljava/lang/StackTraceElement;
    invoke-virtual {v2}, Ljava/lang/StackTraceElement;->getClassName()Ljava/lang/String;

    move-result-object v5

    const-string v6, "android.security.cts.EncryptionTest"
    ...
    const-string/jumbo v6, "testEncryption"
    ...
    .line 522
    .end local v2    # "item":Ljava/lang/StackTraceElement;
    :goto_1
    return v5

    .line 516
    .restart local v2    # "item":Ljava/lang/StackTraceElement;
    :cond_0
...
.method public registerProcessStateListener(Landroid/app/ActivityManager$ProcessStateListener;)V
    .locals 3
    .param p1, "l"    # Landroid/app/ActivityManager$ProcessStateListener;
    ...
    invoke-direct {v2, p0, p1}, Landroid/app/ActivityManager$1;-><init>(Landroid/app/ActivityManager;Landroid/app/ActivityManager$ProcessStateListener;)V

    invoke-interface {v1, v2}, Landroid/app/IActivityManager;->registerProcessStateListener(Landroid/app/IProcessStateListener;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
