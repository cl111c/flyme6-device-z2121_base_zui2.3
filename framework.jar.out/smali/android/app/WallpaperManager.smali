...
.field public static final BLUR_FILE_NAME:Ljava/lang/String; = "blur_wallpaper"

.field private static final BLUR_SCALE_FACTOR:F = 16.0f
...
.field public static final HIGH_DIFINITION_FILE_NAME:Ljava/lang/String; = "wallpaper"

.field public static final LOCK_FILE_NAME:Ljava/lang/String; = "default"

.field public static final LOCK_PATH:Ljava/lang/String; = "/sdcard/.keyguard/customized/"
...
.field private static final enableSetwallpaperAppList:[Ljava/lang/String;
...
# instance fields
.field private isClearWallpaper:Z
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/app/WallpaperManager;->enableSetwallpaperAppList:[Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-boolean v0, p0, Landroid/app/WallpaperManager;->isClearWallpaper:Z
...
.method private deleteAllFiles(Ljava/lang/String;Ljava/lang/Boolean;)V
    .locals 7
    ...
    .line 1451
    :cond_1
    const-string/jumbo v4, "wallpapermanager"

    const-string v5, "     filelist is null  "
    ...
    const-string v6, "   delete file   is     "
...
.method private enableSetwallpaperApp()Z
    .locals 5
    ...
    const-string/jumbo v4, "preset_default_wallpaper"
    ...
    .local v0, "i":I
    :goto_0
    sget-object v3, Landroid/app/WallpaperManager;->enableSetwallpaperAppList:[Ljava/lang/String;
...
.method private getWallpaperValue(Landroid/content/Context;)I
    .locals 4
    .param p1, "context"    # Landroid/content/Context;
    ...
    const-string/jumbo v2, "set_wallpaper_value"
    ...
    .line 1381
    .local v0, "value":I
    const-string/jumbo v1, "wallpapermanager"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "   :  set wallpaper value is    "
...
.method private isHighDefinitionWallpaper(Landroid/content/Context;)Z
    .locals 5
    .param p1, "context"    # Landroid/content/Context;
    ...
    const-string v4, "high_definition_wallpaper"
...
.method private isHomesettingSetHighWallpaper(Landroid/content/Context;)Z
    .locals 5
    .param p1, "context"    # Landroid/content/Context;
    ...
    const-string v4, "homesetting_set_high_wallpaper"
...
.method private isNeedCutWallpaper(Landroid/content/Context;)Z
    .locals 4
    .param p1, "context"    # Landroid/content/Context;
    ...
    .line 1358
    invoke-direct {p0, p1}, Landroid/app/WallpaperManager;->getWallpaperValue(Landroid/content/Context;)I

    move-result v0

    .line 1359
    .local v0, "value":I
    iget-boolean v3, p0, Landroid/app/WallpaperManager;->isClearWallpaper:Z
...
.method private isNoNeedCopyLockWallpaper(Landroid/content/Context;)Z
    .locals 3
    .param p1, "context"    # Landroid/content/Context;
...
# virtual methods
.method public changeSize(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 3
    ...
    .line 1541
    :goto_1
    invoke-virtual {p0, p1, v1, v0}, Landroid/app/WallpaperManager;->cutBitmapwid(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;

    move-result-object v2

    invoke-virtual {p0, v2, p3, p2}, Landroid/app/WallpaperManager;->zoomBitmapAll(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public clear()V
    ...
    .line 1277
    iput-boolean v3, p0, Landroid/app/WallpaperManager;->isClearWallpaper:Z

    .line 1278
    const-string v0, "/sdcard/.keyguard/customized/"

    invoke-static {v2}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Landroid/app/WallpaperManager;->deleteAllFiles(Ljava/lang/String;Ljava/lang/Boolean;)V

    .line 1279
    invoke-virtual {p0, v3}, Landroid/app/WallpaperManager;->clear(Z)V

    .line 1280
    iput-boolean v2, p0, Landroid/app/WallpaperManager;->isClearWallpaper:Z
...
.method public cutBitmapwid(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 7
    .param p1, "bitmap"    # Landroid/graphics/Bitmap;
    .param p2, "w"    # I
    .param p3, "h"    # I
    ...
    .line 1571
    .local v3, "yOffset":I
    const-string v4, "KEGUOQING"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "xOffset:"
...
.method public getBlurBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 13
    .param p1, "context"    # Landroid/content/Context;
    ...
    .line 1402
    invoke-virtual {v3, p2, v11, v11, v4}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {v2, v8}, Landroid/renderscript/ScriptIntrinsicBlur;->setRadius(F)V
...
.method public saveToPath(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    .locals 7
    .param p1, "bitmap"    # Landroid/graphics/Bitmap;
    ...
    const-string v5, "/sdcard/.keyguard/customized/"

    invoke-direct {v0, v5}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 1469
    .local v0, "dirF":Ljava/io/File;
    invoke-virtual {v0}, Ljava/io/File;->exists()Z
...
.method public setBitmap(Landroid/graphics/Bitmap;)V
    ...
    # getter for: Landroid/app/WallpaperManager$Globals;->mService:Landroid/app/IWallpaperManager;
    invoke-static {v10}, Landroid/app/WallpaperManager$Globals;->access$100(Landroid/app/WallpaperManager$Globals;)Landroid/app/IWallpaperManager;
    ...
    const-string v11, "WallpaperService not running"
    ...
    .line 806
    :cond_1
    const-string v7, "WALLPAPER_"

    .line 807
    .local v7, "nameStr":Ljava/lang/String;
    iget-object v10, p0, Landroid/app/WallpaperManager;->mContext:Landroid/content/Context;

    invoke-direct {p0, v10}, Landroid/app/WallpaperManager;->getWallpaperValue(Landroid/content/Context;)I
    ...
    const-string v11, "_EVERYDAYPUSH"
    ...
    invoke-direct {p0, v10}, Landroid/app/WallpaperManager;->isNeedCutWallpaper(Landroid/content/Context;)Z

    move-result v5

    .line 819
    .local v5, "mNeedCutPaper":Z
    iget-object v10, p0, Landroid/app/WallpaperManager;->mContext:Landroid/content/Context;

    invoke-direct {p0, v10}, Landroid/app/WallpaperManager;->isNoNeedCopyLockWallpaper(Landroid/content/Context;)Z

    move-result v6

    .line 820
    .local v6, "mNoNeedCopyLockWallpaper":Z
    const-string/jumbo v10, "wallpapermanager"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "   name string is   :  "
    ...
    invoke-interface {v10, v7, v11}, Landroid/app/IWallpaperManager;->setWallpaper(Ljava/lang/String;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p1, v10, v11, v2}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    :try_end_2
    ...
    .line 810
    .end local v5    # "mNeedCutPaper":Z
    .end local v6    # "mNoNeedCopyLockWallpaper":Z
    :cond_6
    if-eqz v8, :cond_7
    ...
    const-string v11, "HIGHWALLPAPER"
    ...
    .restart local v5    # "mNeedCutPaper":Z
    .restart local v6    # "mNoNeedCopyLockWallpaper":Z
    :cond_9
    :try_start_4
    const-string v10, "/sdcard/.keyguard/customized/"

    invoke-static {v6}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v11

    invoke-direct {p0, v10, v11}, Landroid/app/WallpaperManager;->deleteAllFiles(Ljava/lang/String;Ljava/lang/Boolean;)V

    .line 837
    const-string v10, "/sdcard/.keyguard/customized/wallpaper"

    invoke-virtual {p0, p1, v10}, Landroid/app/WallpaperManager;->saveToPath(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v10, p1}, Landroid/app/WallpaperManager;->getBlurBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v10

    invoke-virtual {p0, v10, v9, v3}, Landroid/app/WallpaperManager;->zoomBitmapAll(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;

    move-result-object v4

    .line 845
    .local v4, "mBitmap":Landroid/graphics/Bitmap;
    const-string v10, "/sdcard/.keyguard/customized/blur_wallpaper"

    invoke-virtual {p0, v4, v10}, Landroid/app/WallpaperManager;->saveToPath(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v10, v11}, Landroid/app/WallpaperManager;->changeSize(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;

    move-result-object v10

    const-string v11, "/sdcard/.keyguard/customized/default"

    invoke-virtual {p0, v10, v11}, Landroid/app/WallpaperManager;->saveToPath(Landroid/graphics/Bitmap;Ljava/lang/String;)V

    .line 849
    :cond_b
    iget-object v10, p0, Landroid/app/WallpaperManager;->mContext:Landroid/content/Context;

    invoke-direct {p0, v10}, Landroid/app/WallpaperManager;->isHighDefinitionWallpaper(Landroid/content/Context;)Z
    ...
    invoke-virtual {v4, v10, v11, v2}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    :try_end_6
...
.method public setResource(I)V
    ...
    invoke-direct {p0, v1}, Landroid/app/WallpaperManager;->isNeedCutWallpaper(Landroid/content/Context;)Z
...
.method public zoomBitmapAll(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 9
    .param p1, "bitmap"    # Landroid/graphics/Bitmap;
    .param p2, "w"    # I
    .param p3, "h"    # I
...
.method public zoomBitmaphei(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 9
    .param p1, "bitmap"    # Landroid/graphics/Bitmap;
    .param p2, "w"    # I
    .param p3, "h"    # I
...
.method public zoomBitmapwid(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 8
    .param p1, "bitmap"    # Landroid/graphics/Bitmap;
    .param p2, "w"    # I
    .param p3, "h"    # I
