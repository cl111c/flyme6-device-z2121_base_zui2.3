...
.method public static installPackage(Landroid/content/Context;Ljava/io/File;)V
    ...
    invoke-static {}, Landroid/os/RecoverySystem;->releaseCacheSpace()V
    ...
    const v6, #android:string@config_UpgradeType#t
    ...
    const-string v7, "[wwq] config_UpgradeType: "
    ...
    const-string v7, "[wwq] config update_package to : "
    ...
    const-string v7, "[wwq] context.getPackageName() = "
    ...
    const-string v5, "com.zui.otaserver"
    ...
    :cond_2
    const-string v5, "com.zui.easyimage"
    ...
    const-string v7, "[wwq] ship filename setting to \'@/cache/recovery/block.map\' for package "
...
.method private static releaseCacheSpace()V
    .locals 11
    ...
    .line 330
    .local v2, "cacheStatus":Landroid/os/StatFs;
    ...
    const-string v10, "[wwq][releaseCacheSpace] freeSize = "
    ...
    const-string v9, "[wwq][releaseCacheSpace] !!! remove /cache/backup/* !!!"

    invoke-static {v8, v9}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    .line 338
    new-instance v3, Lcom/android/internal/backup/LocalTransport;

    const/4 v8, 0x0

    invoke-direct {v3, v8}, Lcom/android/internal/backup/LocalTransport;-><init>(Landroid/content/Context;)V

    .line 339
    .local v3, "lt":Lcom/android/internal/backup/LocalTransport;
    invoke-virtual {v3}, Lcom/android/internal/backup/LocalTransport;->initializeDevice()I

    .line 340
    const-string v8, "RecoverySystem"

    const-string v9, "[wwq][releaseCacheSpace] !!! remove ok!!!"

    invoke-static {v8, v9}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    .line 342
    .end local v3    # "lt":Lcom/android/internal/backup/LocalTransport;
    :cond_0
    return-void
.end method
