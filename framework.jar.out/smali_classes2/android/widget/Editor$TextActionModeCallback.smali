...
.method private populateMenuWithItems(Landroid/view/Menu;)V
    ...
    .line 3229
    invoke-direct {p0, p1}, Landroid/widget/Editor$TextActionModeCallback;->updateSelectItem(Landroid/view/Menu;)V
...
.method private updateSelectItem(Landroid/view/Menu;)V
    .locals 7
    .param p1, "menu"    # Landroid/view/Menu;

    .prologue
    const v6, #android:id@right_icon#t
    ...
    invoke-virtual {v4}, Landroid/widget/TextView;->hasPasswordTransformationMethod()Z
    ...
    const v5, #android:string@select#t
    ...
    .end local v0    # "canSelect":Z
    .end local v1    # "selectItemExists":Z
    :cond_1
    move v0, v3
    ...
    .line 3286
    .restart local v1    # "selectItemExists":Z
    :cond_3
    if-nez v0, :cond_0
...
.method public onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    # invokes: Landroid/widget/Editor;->onSelectItemClick()V
    invoke-static {v2}, Landroid/widget/Editor;->access$3300(Landroid/widget/Editor;)V
...
.method public onGetContentRect(Landroid/view/ActionMode;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {v9}, Landroid/widget/Editor;->access$3400(Landroid/widget/Editor;)Landroid/text/Layout;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    # getter for: Landroid/widget/Editor;->mIsFloatingMenu:Z
    invoke-static {v1}, Landroid/widget/Editor;->access$3100(Landroid/widget/Editor;)Z
    ...
    .line 3240
    invoke-direct {p0, p2}, Landroid/widget/Editor$TextActionModeCallback;->updateSelectItem(Landroid/view/Menu;)V
