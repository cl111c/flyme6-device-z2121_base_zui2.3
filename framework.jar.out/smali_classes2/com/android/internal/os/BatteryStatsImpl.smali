...
.field static final MAX_MAX_HISTORY_BUFFER:I = 0x90000
...
.method public constructor <init>(Ljava/io/File;Landroid/os/Handler;Lcom/android/internal/os/BatteryStatsImpl$ExternalStatsSync;)V
    ...
    .line 6870
    invoke-static {p1}, Lcom/android/internal/os/BatteryStatsImpl;->removeStatsFile(Ljava/io/File;)V
...
.method private static deleteStatsFile(Ljava/io/File;Ljava/lang/String;)V
    .locals 2
...
.method private static removeStatsFile(Ljava/io/File;)V
    .locals 5
    .param p0, "dir"    # Ljava/io/File;
    ...
    .line 6852
    const-string v2, "persist.sys.currentversion"
    ...
    const-string v4, "removeStatsFile: storedVersion="
    ...
    const-string v3, "First version, no need to clear batterystats file"
    ...
    const-string v3, "Upgraded version, clear batterystats file"
    ...
    invoke-static {p0, v2}, Lcom/android/internal/os/BatteryStatsImpl;->deleteStatsFile(Ljava/io/File;Ljava/lang/String;)V

    .line 6860
    const-string v2, "batterystats.bin.tmp"

    invoke-static {p0, v2}, Lcom/android/internal/os/BatteryStatsImpl;->deleteStatsFile(Ljava/io/File;Ljava/lang/String;)V

    .line 6861
    const-string v2, "batterystats-checkin.bin"

    invoke-static {p0, v2}, Lcom/android/internal/os/BatteryStatsImpl;->deleteStatsFile(Ljava/io/File;Ljava/lang/String;)V

    .line 6862
    const-string v2, "batterystats-daily.xml"
    ...
    const-string v3, "Original version, no need to clear batterystats file"
...
.method public setBatteryStateLocked(IIIIII)V
    ...
    invoke-virtual/range {v10 .. v16}, Landroid/os/BatteryStats$LevelStepTracker;->addLevelStepsFiltered(IJJZ)V
