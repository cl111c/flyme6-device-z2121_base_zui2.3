...
.method public calculateRemaining(Lcom/android/internal/os/BatterySipper;Landroid/os/BatteryStats;JJI)V
    ...
    .line 92
    .local v8, "totalRunningTimeMs":J
    iget-wide v10, p0, Lcom/android/internal/os/WifiPowerEstimator;->mTotalAppWifiRunningTimeMs:J

    sub-long v10, v8, v10

    long-to-double v10, v10

    iget-wide v12, p0, Lcom/android/internal/os/WifiPowerEstimator;->mWifiPowerOn:D
    ...
    .line 94
    .local v4, "powerDrain":D
    move-object/from16 v0, p1

    iput-wide v8, v0, Lcom/android/internal/os/BatterySipper;->wifiRunningTimeMs:J
    ...
    .line 97
    const-string v10, "WifiPowerEstimator"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "calculateRemaining totalRunningTimeMs= "
    ...
    const-string v12, " mTotalAppWifiRunningTimeMs="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-wide v12, p0, Lcom/android/internal/os/WifiPowerEstimator;->mTotalAppWifiRunningTimeMs:J
    ...
    const-string v12, "calculateRemaining mWifiPowerOn= "
    ...
    iput-wide v6, v0, Lcom/android/internal/os/BatterySipper;->usageTimeMs:J
