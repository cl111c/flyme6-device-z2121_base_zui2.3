...
# static fields
.field private static final mBottomHotHeight:J = 0xcL

.field private static final mLeftRightHotHeight:J = 0x48L

.field private static final mLeftRightHotWidth:J = 0xcL

.field private static final mMinTouchSlop:I = 0x2a


# instance fields
.field final CC_MOVE_MAX_TIME:J

.field final CC_SHIFT_MAX_ANGLE:D

.field cacheEvent:[Landroid/view/MotionEvent;
...
.field private mCcHandler:Landroid/os/Handler;

.field mCcHandling:Z

.field mCcStartingX:F

.field mCcstartingY:F
...
.field mPressLeftRightHotType:I
...
.field private final mTriggerNotificationCenterTimeOut:Ljava/lang/Runnable;

.field private mWatchingForMenu:Z

.field private mbMoveOutOfRange:Z

.field private mbPressTime:J
...
.method public constructor <init>(Lcom/android/internal/policy/PhoneWindow;Landroid/content/Context;I)V
    ...
    iput v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mLastTopInset:I

    iput v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mLastBottomInset:I

    iput v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mLastRightInset:I

    iput-boolean v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mLastHasTopStableInset:Z

    iput-boolean v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mLastHasBottomStableInset:Z

    iput-boolean v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mLastHasRightStableInset:Z

    iput v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mLastWindowFlags:I

    iput v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mRootScrollY:I

    iput-boolean v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcHandling:Z

    iput-boolean v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mInterceptTouchEvent:Z

    iput v11, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mPressLeftRightHotType:I

    const-wide/high16 v0, 0x3ff0000000000000L    # 1.0

    iput-wide v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->CC_SHIFT_MAX_ANGLE:D

    const-wide/16 v0, 0x258

    iput-wide v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->CC_MOVE_MAX_TIME:J

    iput-boolean v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mbMoveOutOfRange:Z

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mbPressTime:J

    const/16 v0, 0x14

    new-array v0, v0, [Landroid/view/MotionEvent;

    iput-object v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->cacheEvent:[Landroid/view/MotionEvent;

    new-instance v0, Lcom/android/internal/policy/PhoneWindow$DecorView$1;

    invoke-direct {v0, p0}, Lcom/android/internal/policy/PhoneWindow$DecorView$1;-><init>(Lcom/android/internal/policy/PhoneWindow$DecorView;)V

    iput-object v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mTriggerNotificationCenterTimeOut:Ljava/lang/Runnable;

    new-instance v0, Landroid/os/Handler;

    invoke-direct {v0}, Landroid/os/Handler;-><init>()V

    iput-object v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcHandler:Landroid/os/Handler;

    new-instance v0, Landroid/graphics/Point;

    invoke-direct {v0}, Landroid/graphics/Point;-><init>()V

    iput-object v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mDisplaySize:Landroid/graphics/Point;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->minputMethodManager:Landroid/view/inputmethod/InputMethodManager;
    ...
    .line 2284
    .local v9, "windowService":Landroid/view/WindowManager;
    invoke-interface {v9}, Landroid/view/WindowManager;->getDefaultDisplay()Landroid/view/Display;

    move-result-object v0

    iget-object v1, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mDisplaySize:Landroid/graphics/Point;

    invoke-virtual {v0, v1}, Landroid/view/Display;->getRealSize(Landroid/graphics/Point;)V

    .line 2286
    iget-object v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mDisplaySize:Landroid/graphics/Point;
...
.method private createActionMode(ILandroid/view/ActionMode$Callback2;Landroid/view/View;)Landroid/view/ActionMode;
    ...
    invoke-virtual {v0, v1}, Landroid/view/ActionMode;->setType(I)V
...
.method private createFloatingActionMode(Landroid/view/View;Landroid/view/ActionMode$Callback2;)Landroid/view/ActionMode;
    ...
    invoke-direct {v1, p0, v0}, Lcom/android/internal/policy/PhoneWindow$DecorView$5;-><init>(Lcom/android/internal/policy/PhoneWindow$DecorView;Lcom/android/internal/view/FloatingActionMode;)V
...
.method private createStandaloneActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 3641
    new-instance v7, Lcom/android/internal/policy/PhoneWindow$DecorView$3;

    invoke-direct {v7, p0}, Lcom/android/internal/policy/PhoneWindow$DecorView$3;-><init>(Lcom/android/internal/policy/PhoneWindow$DecorView;)V
...
.method private handleTouchEventforCc(Landroid/view/MotionEvent;)V
    .locals 14
    ...
    .line 2627
    iget-object v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mDisplaySize:Landroid/graphics/Point;

    iget v2, v8, Landroid/graphics/Point;->y:I

    .line 2628
    .local v2, "iDisplayHeight":I
    iget-object v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mDisplaySize:Landroid/graphics/Point;

    iget v3, v8, Landroid/graphics/Point;->x:I

    .line 2629
    .local v3, "iDisplayWidth":I
    const/16 v8, 0x8
    ...
    const-wide v10, 0x3ff91eb851eb851fL    # 1.57
    ...
    iput-wide v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mbPressTime:J

    .line 2637
    const/4 v8, 0x0

    iput-boolean v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mbMoveOutOfRange:Z

    .line 2638
    const/4 v8, 0x0

    invoke-direct {p0, v8}, Lcom/android/internal/policy/PhoneWindow$DecorView;->setControlCenterAction(Z)V
    ...
    iput v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcStartingX:F
    ...
    iput v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcstartingY:F
    ...
    iput-boolean v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mInterceptTouchEvent:Z

    .line 2643
    iget-object v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->cacheEvent:[Landroid/view/MotionEvent;
    ...
    iput v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mPressLeftRightHotType:I
    ...
    .line 2760
    .end local v2    # "iDisplayHeight":I
    .end local v3    # "iDisplayWidth":I
    :cond_1
    :goto_0
    return-void

    .line 2649
    .restart local v2    # "iDisplayHeight":I
    .restart local v3    # "iDisplayWidth":I
    :cond_2
    int-to-float v8, v3
    ...
    .line 2666
    :goto_1
    iget v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mPressLeftRightHotType:I
    ...
    .end local v3    # "iDisplayWidth":I
    :cond_7
    iget-boolean v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mInterceptTouchEvent:Z
    ...
    .line 2683
    iget-boolean v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mbMoveOutOfRange:Z

    if-eqz v8, :cond_9

    .line 2685
    iget-boolean v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcHandling:Z
    ...
    .line 2686
    invoke-direct {p0}, Lcom/android/internal/policy/PhoneWindow$DecorView;->launchControlCenter()V
    ...
    iget-wide v10, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mbPressTime:J
    ...
    invoke-virtual {v8}, Lcom/android/internal/policy/PhoneWindow;->getCallback()Landroid/view/Window$Callback;

    move-result-object v0

    .line 2698
    .local v0, "cb1":Landroid/view/Window$Callback;
    const/4 v1, 0x0
    ...
    iget v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mFeatureId:I
    ...
    invoke-interface {v0, v8}, Landroid/view/Window$Callback;->dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-super {p0, v8}, Landroid/widget/FrameLayout;->dispatchTouchEvent(Landroid/view/MotionEvent;)Z

    goto :goto_4

    .line 2709
    .end local v0    # "cb1":Landroid/view/Window$Callback;
    .end local v1    # "i":I
    :cond_c
    const/4 v8, 0x0
    ...
    .line 2722
    .restart local v0    # "cb1":Landroid/view/Window$Callback;
    const/4 v1, 0x0
    ...
    iput v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcEndingX:F
    ...
    iput v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcEndingY:F

    .line 2738
    iget v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcEndingX:F

    iget v9, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcStartingX:F
    ...
    .line 2739
    .local v4, "xShift":D
    iget v8, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcEndingY:F

    iget v9, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcstartingY:F
    ...
    const-wide/high16 v8, -0x3fbb000000000000L    # -42.0
...
.method private launchControlCenter()V
    .locals 3

    .prologue
    .line 2614
    iget v1, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcEndingY:F
    ...
    iget v2, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcstartingY:F
    ...
    const-string v1, "ACTION.LONGPRESS.MENU"
...
.method private setControlCenterAction(Z)V
    .locals 4
    .param p1, "enabled"    # Z
    ...
    .line 2602
    iput-boolean p1, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcHandling:Z

    .line 2604
    if-nez p1, :cond_0

    .line 2605
    iput v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcEndingY:F

    iput v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcstartingY:F

    .line 2606
    iput v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcEndingX:F

    iput v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcStartingX:F

    .line 2607
    iget-object v0, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mCcHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mTriggerNotificationCenterTimeOut:Ljava/lang/Runnable;
...
.method private setHandledFloatingActionMode(Landroid/view/ActionMode;)V
    ...
    :goto_0
    invoke-direct {v1, v2, v3, v0}, Lcom/android/internal/widget/FloatingToolbar;-><init>(Landroid/content/Context;Landroid/view/Window;Z)V

    iput-object v1, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mFloatingToolbar:Lcom/android/internal/widget/FloatingToolbar;
...
.method private setHandledPrimaryActionMode(Landroid/view/ActionMode;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/internal/policy/PhoneWindow$DecorView$4;-><init>(Lcom/android/internal/policy/PhoneWindow$DecorView;)V
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->minputMethodManager:Landroid/view/inputmethod/InputMethodManager;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->minputMethodManager:Landroid/view/inputmethod/InputMethodManager;
    ...
    const-string v3, "com.zui.setupwizard"
    ...
    const-string v3, "com.android.cts.ui"
    ...
    .line 2428
    invoke-direct {p0, p1}, Lcom/android/internal/policy/PhoneWindow$DecorView;->handleTouchEventforCc(Landroid/view/MotionEvent;)V

    .line 2429
    iget-boolean v3, p0, Lcom/android/internal/policy/PhoneWindow$DecorView;->mInterceptTouchEvent:Z
